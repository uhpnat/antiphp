    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="finance-performance.php" class="menu-link py-2 active">
                        <span class="menu-title">
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../apps/user-management/users/view.php" >
                Learn More            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
        ...
        <div class="card-toolbar">            
            ...
            <ul class="nav" id="kt_chart_widget_19_tabs">
                <li class="nav-item">
                    ...
                    id="kt_chart_widget_25_tab_1" href="#kt_chart_widget_25_tab_content_1">2023</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light active fw-bold px-4" data-bs-toggle="tab" 
                    id="kt_chart_widget_25_tab_2" href="#kt_chart_widget_25_tab_content_2">Month</a>
                </li>                
            </ul>             
        </div>
        <!--end::Toolbar-->
