    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="store-analytics.php" class="menu-link py-2 active">
                        <span class="menu-title">
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            <!--begin::Link-->
            <a class="btn btn-sm btn-primary me-2"  href="../apps/ecommerce/customers/listing.php" >
                Try now            </a>
            <!--end::Link-->
...
<div class="card card-flush h-md-100">
    ...
    <div class="card-header pt-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/catalog/categories.php" class="btn btn-sm btn-light">View All</a>        
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                ...
                <tbody>
                            ...
                            <td class="ps-0">
                                <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                            ...
                            <td class="ps-0">
                                <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                            ...
                            <td class="ps-0">
                                <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                            ...
                            <td class="ps-0">
                                <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Yellow Stone</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                                <span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">$72.00</span>
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7 mb-5">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/sales/listing.php" class="btn btn-sm btn-light">View All</a>          
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body d-flex align-items-end">  
        ...
        <div class="w-100">           
                ...
                <div class="text-center pt-8 d-1">                 
                    <a href="../apps/ecommerce/sales/details.php" class="text-primary opacity-75-hover fs-6 fw-bold">
