    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="delivery.php" class="menu-link py-2 active">
                        <span class="menu-title">
                            Delivery                        </span>
                    </a>
                    <!--end:Menu link-->
    ...
    <div class="card-body d-flex flex-column pt-13 pb-14">  
        ...
        <div class="m-0">
            ...
            <h1 class="fw-semibold text-white text-center lh-lg mb-9">           
                Delivery is easy <br/>                <span class="fw-bolder"> Start Your Delivery</span>
            </h1>
            <!--end::Title-->  
        ...
        <div class="text-center"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm bg-white btn-color-white bg-opacity-20"  href="../pages/user-profile/projects.php" >
                Quick Guide            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
        ...
        <ul class="nav nav-pills nav-pills-custom mb-3 mx-9">
                ...
                <li class="nav-item mb-3 me-3 me-lg-6">
                    ...
                    <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 
                        active" data-bs-toggle="pill" id="kt_charts_widget_32_tab_1" 
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/catalog/add-product.php" class="btn btn-sm btn-light">Add Product</a>             
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
        ...
        <!--end::Content-->
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Fjallraven</a>
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <!--begin::Section-->                                  
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Nike AirMax</a>
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <!--begin::Section-->                                  
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Bose QC 35</a>
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <!--begin::Section-->                                  
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Greeny</a>
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <!--begin::Section-->                                  
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Apple Watches</a>
            ...
            <div class="d-flex flex-stack">                 
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <!--begin::Section-->                                  
                    <div class="flex-grow-1">
                        <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Friendly Robot</a>
