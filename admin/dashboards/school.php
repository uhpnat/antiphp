    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="school.php" class="menu-link py-2 active">
                        <span class="menu-title">
                            School                        </span>
                    </a>
                    <!--end:Menu link-->
...
<div class="card bg-primary h-xl-100"> 
    ...
    <div class="card-body d-flex flex-column pt-13 pb-14">  
        ...
        <div class="text-center"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm bg-white btn-color-white bg-opacity-20"  href="../pages/careers/list.php" >
                Nurse            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                ...
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3">
                                                    <i class="ki-outline ki-printer fs-3"></i>                                                </a>
                                                <!--end::Print-->

                                                <!--begin::Chat-->            
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3">
                                                    <i class="ki-outline ki-sms fs-3"></i>                                                </a>
                                                <!--end::Chat-->

                                                <!--begin::Attach-->
                                                <a href="#" class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm">
                                                    <i class="ki-outline ki-paper-clip fs-3"></i>                                                </a>
                                                <!--end::Attach-->
                                            </div>
                                            <!--end::Icon-->    
                                        </td>
