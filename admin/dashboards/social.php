    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="social.php" class="menu-link py-2 active">
                        <span class="menu-title">
                            Social                        </span>
                    </a>
                    <!--end:Menu link-->
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../pages/user-profile/activity.php" >
                Learn more            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
                    ...
                    <div class="mb-3">
                            ...
                            <div class="d-flex flex-stack"> 
                                ...
                                <div class="m-0">                    
                                    ...
                                    <span class="text-gray-400 fw-semibold fs-6">Avarage <br/> Likes</span>
                                </div>                   
                                <!--end::Section-->                        
                                ...
                                <div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">  
                                    ...
                                    <div class="mb-2">
                                        <select class="form-select form-select-transparent p-0 w-150px me-n5" data-control="select2" data-placeholder="All Users" data-dropdown-css-class="w-150px" data-hide-search="true">                                     
                                            <option value="1" selected>Jul 22 - Aug 22</option>
                            ...
                            <div class="d-flex flex-stack"> 
                                ...
                                <div class="m-0">                    
                                    ...
                                    <span class="text-gray-400 fw-semibold fs-6">Avarage <br/> Comments</span>
                                </div>                   
                                <!--end::Section-->                        
                            ...
                            <div class="d-flex flex-stack"> 
                                ...
                                <div class="m-0">                    
                                    ...
                                    <span class="text-gray-400 fw-semibold fs-6">Avarage <br/> Shares</span>
                                </div>                   
                                <!--end::Section-->                        
        ...
        <div class="d-flex flex-stack flex-wrap gap-4">
            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <a href="#" class="text-hover-primary ps-4" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                    <i class="ki-outline ki-filter fs-2 text-gray-400"></i>                </a>
                

<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b18edb337d">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b18edb337d" data-allow-clear="true">
                    <option></option>
            ...
            <tbody>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-icon btn-sm btn-light btn-active-primary w-25px h-25px">
                                <i class="ki-outline ki-black-right fs-2 text-muted"></i>                            </button>
                        </td>
                    </tr>
                                    <tr>
                        <td class="min-w-175px">
