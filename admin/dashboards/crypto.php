    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="crypto.php" class="menu-link py-2 active">
                        <span class="menu-title">
                            Crypto                        </span>
                    </a>
                    <!--end:Menu link-->
            ...
            <div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">  
                ...
                <div class="form-floating border border-gray-300 rounded mb-7">
                    <select class="form-select form-select-transparent" id="kt_forms_widget_1_select_1">
                        <option> </option>
                                                    <option value="0" data-kt-select2-icon="/metronic8/demo30/assets/media/svg/coins/bitcoin.svg" selected>Bitcoin/BTC</option>
        ...
        <div class="px-9 mb-5">   
            ...
            <div class="d-flex align-items-center mb-2">   
                ...
                <span class="badge badge-success fs-base">                                
                    <i class="ki-outline ki-arrow-up fs-5 text-white ms-n1"></i> 
                    4.5%
                </span>
                <!--end::Label-->
            </div>
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../apps/ecommerce/sales/listing.php" >
                Learn More            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
                ...
                <tbody>
                            ...
                            <td>
                                <div class="symbol symbol-40px">
                                    <span class="symbol-label bg-light-info">
                                        <i class="ki-outline ki-abstract-24 fs-2x text-info"></i>                                    </span>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="symbol symbol-40px">
                                    <span class="symbol-label bg-light-success">
                                        <i class="ki-outline ki-flask fs-2x text-success"></i>                                    </span>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="symbol symbol-40px">
                                    <span class="symbol-label bg-light-danger">
                                        <i class="ki-outline ki-abstract-33 fs-2x text-danger"></i>                                    </span>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="symbol symbol-40px">
                                    <span class="symbol-label bg-light-primary">
                                        <i class="ki-outline ki-abstract-47 fs-2x text-primary"></i>                                    </span>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="symbol symbol-40px">
                                    <span class="symbol-label bg-light-warning">
                                        <i class="ki-outline ki-technology-2 fs-2x text-warning"></i>                                    </span>
                                </div>
                            </td>  
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-5">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="#" class="btn btn-sm btn-light" class="btn btn-sm btn-light">All Courses</a>             
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
        ...
        <div class="" data-kt-modal-top-up-wallet-option="dollar">
            ...
            <div class="fv-row mb-10">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-5">
                    ...
                    <div class="col">
                        <!--begin::Add new card-->
                        <a href="../utilities/modals/forms/new-card.php" class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100">
                            <!--begin::Icon-->
...
<!--end::Modal - Create Campaign--><!--begin::Modal - Create account-->
...
<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 ">To start using great tools, please, <a href="../utilities/wizards/vertical.php" class="fw-bold">Create Team Platform</a></div>
                            </div>
            <!--end::Content-->
