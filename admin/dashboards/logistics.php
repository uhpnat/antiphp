    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="logistics.php" class="menu-link py-2 active">
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../apps/invoices/view/invoice-2.php" >
                Quick Guide            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-body pt-4">                 
        ...
        <div class="text-center pt-9">
            <a href="../apps/ecommerce/catalog/add-product.php" class="btn btn-primary">Add Vehicle</a>
        </div>
    </div>
    <!--end::Body-->
</div>
