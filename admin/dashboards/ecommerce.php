...
>   
    ...
    <div 
        ...
        data-kt-menu="true"
    >        
        <!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="-50,0"  class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2" ><!--begin:Menu link--><span class="menu-link" ><span  class="menu-title" >Dashboards</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px" ><!--begin:Dashboards menu-->
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="ecommerce.php" class="menu-link active">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="online-courses.php" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="bidding.php" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="call-center.php" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="logistics.php" class="menu-link py-2 ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="website-analytics.php" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="finance-performance.php" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="store-analytics.php" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="social.php" class="menu-link py-2 ">
                        <span class="menu-title">
                            Social                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="delivery.php" class="menu-link py-2 ">
                        <span class="menu-title">
                            Delivery                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="crypto.php" class="menu-link py-2 ">
                        <span class="menu-title">
                            Crypto                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="school.php" class="menu-link py-2 ">
                        <span class="menu-title">
                            School                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="podcast.php" class="menu-link py-2 ">
                        <span class="menu-title">
                            Podcast                        </span>
                    </a>
                    <!--end:Menu link-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                            <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                        </td>
                                        <td>                                            
                                            <span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                        ...
                                        <td class="ps-0">
                                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            <!--begin::Link-->
            <a class="btn btn-sm btn-primary me-2"  href="../apps/ecommerce/sales/listing.php" >
                View App            </a>
            <!--end::Link-->

            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../apps/ecommerce/catalog/add-product.php" >
                New Product            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
            ...
            <tbody class="fw-bold text-gray-600">
                <tr data-kt-table-widget-4="subtable_template" class="d-none">
                    <td colspan="2">
                        <div class="d-flex align-items-center gap-3">
                            <a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
                                <img src="#" data-kt-src-path="/metronic8/demo30/assets/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
                            </a>
                    ...
                    <td></td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#XGY-346</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#YHD-047</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#SRR-678</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#PXF-534</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#XGD-249</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#SKP-035</a>
                        </td>
                        ...
                        <td class="text-end">
                            <button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
                                <i class="ki-outline ki-plus fs-4 m-0 toggle-off"></i>                                <i class="ki-outline ki-minus fs-4 m-0 toggle-on"></i>                            </button>
                                    ...
                                    <tr>
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary">#SKP-567</a>
                        </td>
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/sales/details.php" class="btn btn-sm btn-light">Order Details</a>          
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
...
<!--end::Menu 2-->
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <span class="text-gray-400 fw-bold">To: 
                            <a href="../apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fw-bold">
                                Jason Bourne                            </a>
                        </span>                   
                        <!--end::Name-->
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            ...
                            <!--begin::Title-->  
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Wrapper-->                     
                ...
                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">                 
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <div class="me-3">            
                            ...
                            <!--begin::Title-->  
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Wrapper-->                     
    ...
    <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex flex-stack flex-wrap gap-4">
                ...
                <!--begin::Search-->
                <a href="../apps/ecommerce/catalog/products.php" class="btn btn-light btn-sm">View Stock</a>
                <!--end::Search-->
            </div>
            <!--begin::Filters-->
        </div>
    ...
    <div class="card-body">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
            ...
            <tbody class="fw-bold text-gray-600">
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">Macbook Air M1</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">Surface Laptop 4</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">Logitech MX 250</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">AudioEngine HD3</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">HP Hyper LTR</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">Dell 32 UltraSharp</a>
                        </td>
                        <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <td>
                            <a href="../apps/ecommerce/catalog/edit-product.php" class="text-dark text-hover-primary">Google Pixel 6 Pro</a>
                        </td>
                        <!--end::Item-->
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="store-analytics.php">
				Store Analytics			</a>
			...
			<a class="fw-6 fw-semibold" href="online-courses.php">
				Online Courses			</a>
			...
			<a class="fw-6 fw-semibold" href="finance-performance.php">
				Finance Performance			</a>

		
			
		
			<a class="fw-6 fw-semibold" href="website-analytics.php">
				Website Analytics			</a>
