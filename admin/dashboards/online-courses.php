        ...
        <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="online-courses.php" class="menu-link active">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
...
<div class="card card-flush h-xl-100" >   
    ...
    style="background-image:url('/metronic8/demo30/assets/media/svg/shapes/top-green.png" data-bs-theme="light">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column text-white pt-15">
            ...
            <div class="fs-4 text-white">
                ...
                <span class="position-relative d-inline-block">
                    <a href="../pages/user-profile/projects.php" class="link-white opacity-75-hover fw-bold d-block mb-1">4 tasks</a>
                            ...
                            <div class="d-flex d-grid gap-5">
                                ...
                                <div class="d-flex flex-column flex-shrink-0 me-4">
                                    ...
                                    <span class="d-flex align-items-center fs-7 fw-bold text-gray-400 mb-2">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 3 Topics
                                    </span>
                                    <!--end::Section-->

                                    <!--begin::Section-->
                                    <span class="d-flex align-items-center text-gray-400 fw-bold fs-7">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 1 Speakers
                                    </span>
                                    <!--end::Section-->
                                </div>
                                <!--end::Item--> 
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex d-grid gap-5">
                                ...
                                <div class="d-flex flex-column flex-shrink-0 me-4">
                                    <!--begin::Section-->
                                    <span class="d-flex align-items-center fs-7 fw-bold text-gray-400 mb-2">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 5 Topics
                                    </span>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-column flex-shrink-0">
                                    <!--begin::Section-->
                                    <span class="d-flex align-items-center fs-7 fw-bold text-gray-400 mb-2">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 60 Min
                                    </span>
                                    <!--end::Section-->

                                    <!--begin::Section-->
                                    <span class="d-flex align-items-center text-gray-400 fw-bold fs-7">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 137 students
                                    </span>
                                    <!--end::Section-->
                                </div>
                                <!--end::Item-->  
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex d-grid gap-5">
                                ...
                                <div class="d-flex flex-column flex-shrink-0 me-4">
                                    <!--begin::Section-->
                                    <span class="d-flex align-items-center fs-7 fw-bold text-gray-400 mb-2">
                                        <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i> 12 Topics
                                    </span>
                                    <!--end::Section-->
    ...
    <div class="card-body d-flex ps-xl-15">          
        ...
        <div class="m-0">
            ...
            <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
                <span class="me-2">
                    ...
                    <span class="position-relative d-inline-block text-danger">
                        <a href="../pages/user-profile/overview.php" class="text-danger opacity-75-hover">2300 bonus</a>  
            ...
            <div class="mb-3">
                ...
                <a href="../apps/support-center/overview.php" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold">
                    How to
                </a> 
            </div>
            <!--begin::Action--> 
    ...
    <div class="card-body pt-6">
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">UI/UX Design</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">QA Analysis</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Web Development</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Marketing</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Philosophy</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Mathematics</a>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-1-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="/metronic8/demo30/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane" id="kt_timeline_widget_1_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-1-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_1_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="/metronic8/demo30/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane" id="kt_timeline_widget_1_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-1-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_1_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="/metronic8/demo30/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
