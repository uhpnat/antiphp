                ...
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mb-6">
                            ...
                            <a href="../apps/projects/users.php" class="text-gray-800 text-hover-primary fs-1 fw-bold">California Art</a>
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                            ...
                            <div class="d-flex align-items-center me-5 me-xl-13">
                                ...
                                <div class="m-0">                            
                                    ...
                                    <a href="../apps/projects/users.php" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert Fox</a>
                                </div>
                                <!--end::Info-->
                            </div>                    
                            <!--end::Item-->  
...
<div class="card card-flush h-xl-100">  
    ...
    <div class="card-body text-center pb-5"> 
        ...
        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="../assets/media/stock/600x600/img-39.jpg">      
            ...
            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                style="height: 266px;background-image:url('/metronic8/demo30/assets/media/stock/600x600/img-39.jpg">                     
            </div>
            <!--end::Image-->
    ...
    <div class="card-footer d-flex flex-stack pt-0">  
        ...
        <!--begin::Link-->
        <a class="btn btn-sm btn-light flex-shrink-0"  href="../apps/ecommerce/sales/listing.php" >
            View Item        </a>
        <!--end::Link-->
    </div>
    <!--end::Footer-->
...
<div class="card card-flush h-xl-100">  
    ...
    <div class="card-body text-center pb-5"> 
        ...
        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="../assets/media/stock/600x600/img-47.jpg">      
            <!--begin::Image-->
            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                style="height: 266px;background-image:url('/metronic8/demo30/assets/media/stock/600x600/img-47.jpg">                     
            </div>
            <!--end::Image-->
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/catalog/add-product.php" class="btn btn-sm btn-light">History</a>             
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
                ...
                <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../account/overview.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Brooklyn Simmons</a>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../account/overview.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Annette Black</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-7">Zuid Area</span>
                                    </div>
                                </div>                                
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../account/overview.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-7">Zuid Area</span>
                                    </div>
                                </div>                                
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../account/overview.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-7">Zuid Area</span>
                                    </div>
                                </div>                                
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../account/overview.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Marvin McKinney</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-7">Zuid Area</span>
                                    </div>
                                </div>                                
                            </td>
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../account/settings.php" >
                Learn More            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
...
<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 "> Not enough funds in your wallet? <a href="../utilities/modals/wizards/top-up-wallet.php" class="text-bolder">Top up wallet</a>.</div>
                            </div>
            <!--end::Content-->
...
<!--end::Modal - Users Search--><!--begin::Modal - Create App-->
