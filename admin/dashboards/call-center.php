        ...
        <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="call-center.php" class="menu-link active">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-7 pe-0 mb-5 mb-sm-0">
                ...
                <div class="d-flex justify-content-between h-100 flex-column pt-xl-5 pb-xl-2 ps-xl-7">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="d-flex align-items-center flex-wrap d-grid gap-2 ">
                            ...
                            <div class="d-flex align-items-center me-5 me-xl-13">
                                ...
                                <!--begin::Info-->
                                <div class="m-0">                               
                                    <a href="../pages/user-profile/projects.php" class="text-white text-opacity-75 fs-8">Projects</a>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Info-->
                                <div class="m-0">                            
                                    <a href="../apps/user-management/users/list.php" class="text-white text-opacity-75 fs-8">Tasks</a>
                    ...
                    <!--begin::Action-->             
                    <div class="m-0">
                        <a href="#" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold"  data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                            Upgrade Plan
                        </a> 
                    </div>
                    <!--begin::Action--> 
        ...
        <ul class="nav d-flex justify-content-between mb-3 mx-9">
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-info btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active" 
                        ...
                        href="#kt_charts_widget_37_tab_content_1">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-info btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " 
                        ...
                        href="#kt_charts_widget_37_tab_content_2">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-info btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " 
                        ...
                        href="#kt_charts_widget_37_tab_content_3">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-info btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " 
                        ...
                        href="#kt_charts_widget_37_tab_content_4">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-info btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " 
                        ...
                        href="#kt_charts_widget_37_tab_content_5">               
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="../apps/projects/users.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../apps/projects/users.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../apps/projects/users.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../apps/projects/users.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                    <a href="../apps/projects/users.php" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
...
<div class="card card-flush h-lg-100">
    ...
    <div class="card-header pt-7 mb-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../apps/ecommerce/catalog/add-product.php" class="btn btn-sm btn-light">PDF Report</a>             
        </div>
        <!--end::Toolbar-->
    </div>    
    <!--end::Header-->
