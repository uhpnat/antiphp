    ...
    <div class="row">
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="podcast.php" class="menu-link py-2 active">
                        <span class="menu-title">
                            Podcast                        </span>
                    </a>
                    <!--end:Menu link-->
...
style="background-color:#020202;background-image:url('../assets/media/stock/600x600/img-62.jpg')">       
    ...
    <div class="card-body d-flex justify-content-between flex-column ps-xl-18"> 
        ...
        <div class="mb-xl-10 mb-3">
            <a href='#' class="btn btn-primary fw-semibold me-2"  data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                Listen Now
            </a> 

            <a href="../apps/support-center/overview.php" 
                class="btn btn-color-white bg-transparent btn-outline fw-semibold" style="border: 1px solid rgba(255, 255, 255, 0.3)">
                Save for Later
            </a> 
        </div>
        <!--begin::Action-->
...
<!--end::Menu 2-->
    ...
    <div class="card-body bg-black pt-0">
        ...
        style="background-image:url('../assets/media/stock/600x600/img-59.jpg')">  
        </div>
        <!--end::Image-->
...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="../account/statements.php" class="btn btn-sm btn-light">History</a>          
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-6">
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Leslie Alexander</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Jacob Jones</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ronald Richards</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Courtney Henry</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Arlene McCoy</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../pages/user-profile/overview.php" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Marvin McKinney</a>
        ...
        <div class="row align-items-end h-100 gx-5 gx-xl-10">
                ...
                <div class="col-md-4 mb-11 mb-md-0">              
                    ...
                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="../assets/media/stock/900x600/42.jpg">      
                        ...
                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                            style="height: 266px;background-image:url('/metronic8/demo30/assets/media/stock/900x600/42.jpg">                     
                        </div>
                        <!--end::Image-->
                ...
                <div class="col-md-4 mb-11 mb-md-0">              
                    ...
                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="../assets/media/stock/900x600/40.jpg">      
                        <!--begin::Image-->
                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                            style="height: 266px;background-image:url('/metronic8/demo30/assets/media/stock/900x600/40.jpg">                     
                        </div>
                        <!--end::Image-->
                ...
                <div class="col-md-4 ">              
                    ...
                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="../assets/media/stock/900x600/41.jpg">      
                        <!--begin::Image-->
                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                            style="height: 266px;background-image:url('/metronic8/demo30/assets/media/stock/900x600/41.jpg">                     
                        </div>
                        <!--end::Image-->
...
<div class="card h-md-100" dir="ltr"> 
    ...
    <div class="card-body d-flex flex-column flex-center">  
        ...
        <div class="text-center mb-1"> 
            ...
            <!--begin::Link-->
            <a class="btn btn-sm btn-light"  href="../account/billing.php" >
                Learn More            </a>
            <!--end::Link-->
        </div>
        <!--end::Links-->
