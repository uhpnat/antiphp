        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="../users/view.php" class="menu-link px-3">
            View
        </a>
    </div>
    <!--end::Menu item-->
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
...
<!--end::Menu-->
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../users/view.php" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="../users/list/list.php">
				User Management			</a>
