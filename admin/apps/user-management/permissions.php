    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                        ...
                        <td>
                                                            <a href="roles/view.php" class="badge badge-light-primary fs-7 m-1">Administrator</a>
                                                    </td>
                        <td>
                        ...
                        <td>
                                                            <a href="roles/view.php" class="badge badge-light-primary fs-7 m-1">Administrator</a>
                                                            <a href="roles/view.php" class="badge badge-light-danger fs-7 m-1">Developer</a>
                                                            <a href="roles/view.php" class="badge badge-light-success fs-7 m-1">Analyst</a>
                                                            <a href="roles/view.php" class="badge badge-light-info fs-7 m-1">Support</a>
                                                            <a href="roles/view.php" class="badge badge-light-warning fs-7 m-1">Trial</a>
                                                    </td>
                        <td>
