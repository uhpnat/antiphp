    ...
    <div class="card-body pt-5">
        ...
        <div class="d-flex flex-column gap-5">
                ...
                <div class="d-flex flex-stack">
                    <a href="getting-started.php" class="fs-6 fw-bold text-gray-800 text-hover-primary text-active-primary active">All Contacts</a>
                    <div class="badge badge-light-primary">9</div>
                </div>
                <!--begin::Contact group-->
                            <!--begin::Contact group-->
                <div class="d-flex flex-stack">
                    <a href="getting-started.php" class="fs-6 fw-bold text-gray-800 text-hover-primary ">Subscribed</a>
                    <div class="badge badge-light-primary">3</div>
                </div>
                <!--begin::Contact group-->
                            <!--begin::Contact group-->
                <div class="d-flex flex-stack">
                    <a href="getting-started.php" class="fs-6 fw-bold text-gray-800 text-hover-primary ">Tier 1 Member</a>
                    <div class="badge badge-light-primary">1</div>
                </div>
                <!--begin::Contact group-->
                            <!--begin::Contact group-->
                <div class="d-flex flex-stack">
                    <a href="getting-started.php" class="fs-6 fw-bold text-gray-800 text-hover-primary ">Pending Approval</a>
                    <div class="badge badge-light-primary">3</div>
                </div>
                <!--begin::Contact group-->
                            <!--begin::Contact group-->
                <div class="d-flex flex-stack">
                    <a href="getting-started.php" class="fs-6 fw-bold text-danger text-hover-primary ">Blocked</a>
        ...
        <a href="add-contact.php" class="btn btn-primary w-100">
            <i class="ki-outline ki-badge fs-2"></i>            Add new contact
        </a>
        <!--end::Add new contact-->
    </div>
    <!--end::Card body-->
...
<div class="card card-flush" id="kt_contacts_list">
    ...
    <div class="card-header pt-7" id="kt_contacts_list_header">
        ...
        <form class="d-flex align-items-center position-relative w-100 m-0" autocomplete="off">	
            <!--begin::Icon-->
            <i class="ki-outline ki-magnifier fs-3 text-gray-500 position-absolute top-50 ms-5 translate-middle-y"></i>            <!--end::Icon-->
            ...
            >
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Emma Smith</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Melody Macy</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Max Smith</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Sean Bean</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Brian Cox</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Mikaela Collins</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Francis Mitcham</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Olivia Wild</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Neil Owen</a>
                ...
                <div class="d-flex flex-stack py-4">
                    <!--begin::Details-->
                    <div class="d-flex align-items-center">
                        <!--begin::Avatar--><div class="symbol  symbol-40px symbol-circle "><img alt="Pic" src="../../assets/media/avatars/300-23.jpg"/><div class="symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n2 mt-n2"></div></div><!--end::Avatar-->
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Dan Wilson</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Emma Bold</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Ana Crown</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Robert Doe</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">John Miller</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Lucy Kunic</a>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Ethan Wilder</a>
...
<div class="card card-flush h-lg-100" id="kt_contacts_main">
    ...
    <div class="card-header pt-7" id="kt_chat_contacts_header">
        <!--begin::Card title-->
        <div class="card-title">
            <i class="ki-outline ki-badge fs-1 me-2"></i>            <h2>Contact Details</h2>
        </div>
        <!--end::Card title-->
        ...
        <div class="card-toolbar gap-3">
            ...
            <button class="btn btn-sm btn-light btn-active-light-primary" data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_chat">
                <i class="ki-outline ki-message-text-2 fs-2"></i>                Chat
            </button>
            <!--end::Chat-->

            <!--begin::Chat-->
            <a href="../inbox/reply.php" class="btn btn-sm btn-light btn-active-light-primary">
                <i class="ki-outline ki-messages fs-2"></i>                Message
            </a>
            <!--end::Chat-->
            ...
            <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                <i class="ki-outline ki-dots-square fs-2"></i>            </a>
            <!--begin::Menu-->
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="edit-contact.php" class="menu-link px-3">
            Edit
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3" id="kt_contact_delete" data-kt-redirect="getting-started.php">
            Delete
        </a>
    </div>
    <!--end::Menu item-->
        ...
        <div class="d-flex gap-7 align-items-center">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <i class="ki-outline ki-sms fs-2"></i>                    <a href="#" class="text-muted text-hover-primary">smith@kpmg.com</a>
                </div>
                <!--end::Email-->

                <!--begin::Phone-->
                <div class="d-flex align-items-center gap-2">
                    <i class="ki-outline ki-phone fs-2"></i>                    <a href="#" class="text-muted text-hover-primary">+6141 234 567</a>
                </div>
                <!--end::Phone-->
            </div>
            <!--end::Contact details-->
...
<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x fs-6 fw-semibold mt-6 mb-8 gap-2">
    ...
    <li class="nav-item">
        <a class="nav-link text-active-primary d-flex align-items-center pb-4 active" data-bs-toggle="tab" href="#kt_contact_view_general">
            <i class="ki-outline ki-home fs-4 me-1"></i>            General
        </a>
    </li>
    <!--end:::Tab item-->
    ...
    <li class="nav-item">
        <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#kt_contact_view_meetings">
            <i class="ki-outline ki-calendar-8 fs-4 me-1"></i>            Meetings
        </a>
    </li>
    <!--end:::Tab item-->
    ...
    <li class="nav-item">
        <a class="nav-link text-active-primary d-flex align-items-center pb-4" data-bs-toggle="tab" href="#kt_contact_view_activity">
            <i class="ki-outline ki-save-2 fs-4 me-1"></i>            Activity
        </a>
    </li>
    <!--end:::Tab item-->
</ul>
   ...
   <div class="timeline-label">
       ...
       <div class="timeline-item">
           ...
           <div class="timeline-badge">
                <i class="ki-outline ki-abstract-8 text-warning fs-1"></i>           </div>
           <!--end::Badge-->
       ...
       <div class="timeline-item">
           ...
           <!--begin::Badge-->
           <div class="timeline-badge">
                <i class="ki-outline ki-abstract-8 text-success fs-1"></i>           </div>
           <!--end::Badge-->
       ...
       <div class="timeline-item">
           ...
           <!--begin::Badge-->
           <div class="timeline-badge">
                <i class="ki-outline ki-abstract-8 text-danger fs-1"></i>           </div>
           <!--end::Badge-->
       ...
       <div class="timeline-item">
           ...
           <!--begin::Badge-->
           <div class="timeline-badge">
                <i class="ki-outline ki-abstract-8 text-primary fs-1"></i>           </div>
           <!--end::Badge-->
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="getting-started.php">
				Contacts			</a>
