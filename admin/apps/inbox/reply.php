            ...
            <div class="card-body">
                ...
                <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
                    ...
                    <div class="menu-item mb-3">
                        ...
                        <span class="menu-link active">
                            <span class="menu-icon"><i class="ki-outline ki-sms fs-2 me-3"></i></span>
                    ...
                    <div class="menu-item mb-3">
                        <!--begin::Draft-->
                        <span class="menu-link">
                            <span class="menu-icon"><i class="ki-outline ki-file fs-2 me-3"></i></span>
                    ...
                    <div class="menu-item mb-3">
                        <!--begin::Sent-->
                        <span class="menu-link">
                            <span class="menu-icon"><i class="ki-outline ki-send fs-2 me-3"></i></span>
                    ...
                    <div class="menu-item">
                        <!--begin::Trash-->
                        <span class="menu-link">
                            <span class="menu-icon"><i class="ki-outline ki-trash fs-2 me-3"></i></span>
                ...
                <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary">
                    ...
                    <div class="menu-item">
                        ...
                        <span class="menu-link">
                            <span class="menu-icon">
                                <i class="ki-outline ki-plus fs-2 me-3 lh-0"></i>                            </span>
...
<div class="d-flex">
    ...
    <a href="listing.php" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Back">
        <i class="ki-outline ki-arrow-left fs-1 m-0"></i>    </a>
    <!--end::Back-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive">
        <i class="ki-outline ki-sms fs-2 m-0"></i>    </a>
    <!--end::Archive-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Spam">
        <i class="ki-outline ki-information fs-2 m-0"></i>    </a>
    <!--end::Spam-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
        <i class="ki-outline ki-trash fs-2 m-0"></i>    </a>
    <!--end::Delete-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as read">
        <i class="ki-outline ki-copy fs-2 m-0"></i>    </a>
    <!--end::Mark as read-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Move">
        <i class="ki-outline ki-entrance-left fs-2 m-0"></i>    </a>
    <!--end::Move-->
</div>
<!--end::Actions-->
...
<div class="d-flex align-items-center">
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Previous message">
        <i class="ki-outline ki-left fs-2 m-0"></i>    </a>
    <!--end::Prev page-->
    ...
    <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Next message">
        <i class="ki-outline ki-right fs-2 m-0"></i>    </a>
    <!--end::Next page-->
    ...
    <div>
        <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
            <i class="ki-outline ki-dots-square fs-2 m-0"></i>        </a>
        <!--begin::Menu-->
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3">
            <i class="ki-outline ki-element-11 fs-3 me-3"></i>            New Group
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3">
            <i class="ki-outline ki-badge fs-3 me-3"></i>            Contacts
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3">
            <i class="ki-outline ki-element-2 fs-3 me-3"></i>            Calls
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3">
            <i class="ki-outline ki-setting-2 fs-3 me-3"></i>            Settings
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3">
            <i class="ki-outline ki-magnifier fs-3 me-3"></i>            Help
        </a>
    </div>
    <!--end::Menu item-->
...
<div class="d-flex flex-wrap gap-2 justify-content-between mb-8">
    ...
    <div class="d-flex">
        ...
        <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Sort">
            <i class="ki-outline ki-arrow-up-down fs-2 m-0"></i>        </a>
        <!--end::Sort-->
        ...
        <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Print">
            <i class="ki-outline ki-printer fs-2"></i>        </a>
        <!--end::Print-->
    </div>
</div>
<!--end::Title-->
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="pe-5">
                ...
                <div class="d-flex align-items-center flex-wrap gap-1">
                    ...
                    <i class="ki-outline ki-abstract-8 fs-7 text-success mx-3"></i>                    <span class="text-muted fw-bold">1 day ago</span>
                </div>
                <!--end::Author details-->
  ...
  <div class="d-flex align-items-center flex-wrap gap-2">
      ...
      <div class="d-flex">
          ...
          <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
              <i class="ki-outline ki-star fs-2  m-0"></i>          </a>
          <!--end::Star-->
          ...
          <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as important">
              <i class="ki-outline ki-save-2 fs-2 m-0"></i>          </a>
          ...
          <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Reply">
              <i class="ki-outline ki-message-edit fs-2 m-0"></i>          </a>
          <!--end::Reply-->
          ...
          <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
              <i class="ki-outline ki-dots-square-vertical fs-2 m-0"></i>          </a>
          <!--end::Settings-->
      </div>
  </div>
  <!--end::Actions-->    </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="pe-5">
                ...
                <div class="d-flex align-items-center flex-wrap gap-1">
                    ...
                    <i class="ki-outline ki-abstract-8 fs-7 text-success mx-3"></i>                    <span class="text-muted fw-bold">2 days ago</span>
                </div>
                <!--end::Author details-->
...
<!--end::Menu-->                </div>
  ...
  <div class="d-flex align-items-center flex-wrap gap-2">
      <!--begin::Date-->
      <span class="fw-semibold text-muted text-end me-3">22 Sep 2023, 6:43 am</span>
      <!--end::Date-->

      <div class="d-flex">
          <!--begin::Star-->
          <a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
              <i class="ki-outline ki-star fs-2 text-warning m-0"></i>          </a>
          <!--end::Star-->
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="pe-5">
                ...
                <div class="d-flex align-items-center flex-wrap gap-1">
                    ...
                    <i class="ki-outline ki-abstract-8 fs-7 text-success mx-3"></i>                    <span class="text-muted fw-bold">3 days ago</span>
                </div>
                <!--end::Author details-->
...
<!--end::Menu-->                    
  ...
  <div class="d-flex align-items-center flex-wrap gap-2">
      <!--begin::Date-->
      <span class="fw-semibold text-muted text-end me-3">05 May 2023, 10:30 am</span>
      <!--end::Date-->
    ...
    <div class="d-block">
        ...
        <div class="d-none align-items-center border-bottom ps-8 pe-5 min-h-50px" data-kt-inbox-form="cc">
            ...
            <span class="btn btn-clean btn-xs btn-icon" data-kt-inbox-form="cc_close">
                <i class="ki-outline ki-cross fs-5"></i>            </span>
            <!--end::Close-->
        </div>
        <!--end::CC-->
                ...
                <div class="dropzone-item" style="display:none">
                    ...
                    <div class="dropzone-toolbar">
                        <span class="dropzone-delete" data-dz-remove>
                            <i class="ki-outline ki-cross fs-6"></i>                        </span>
                    </div>
            ...
            <div class="btn-group me-4">
                ...
                <span class="btn btn-primary btn-icon fs-bold" role="button">
                    <span class="btn btn-icon" data-kt-menu-trigger="click" data-kt-menu-placement="top-start">
                        <i class="ki-outline ki-down fs-2 m-0"></i>                    </span>
                    <!--begin::Menu-->
...
<!--end::Menu-->                </span>
            ...
            <span class="btn btn-icon btn-sm btn-clean btn-active-light-primary me-2" id="kt_inbox_reply_attachments_select" data-kt-inbox-form="dropzone_upload">
                <i class="ki-outline ki-paper-clip fs-2 m-0"></i>            </span>
            <!--end::Upload attachement-->

            <!--begin::Pin-->
            <span class="btn btn-icon btn-sm btn-clean btn-active-light-primary">
                <i class="ki-outline ki-geolocation fs-2 m-0"></i>            </span>
            <!--end::Pin-->
        </div>
        <!--end::Actions-->
        ...
        <div class="d-flex align-items-center">
             ...
             <span class="btn btn-icon btn-sm btn-clean btn-active-light-primary me-2" data-toggle="tooltip" title="More actions">
                <i class="ki-outline ki-setting-2 fs-2"></i>            </span>
            <!--end::More actions-->
            ...
            <span class="btn btn-icon btn-sm btn-clean btn-active-light-primary" data-inbox="dismiss" data-toggle="tooltip" title="Dismiss reply">
                <i class="ki-outline ki-trash fs-2"></i>            </span>
            <!--end::Dismiss reply-->
        </div>
        <!--end::Toolbar-->
    </div>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="listing/listing.php">
				Inbox			</a>
