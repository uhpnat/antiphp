...
<!--End::Google Tag Manager -->
    ...
    <!--begin::Body-->
    <body  id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true"  class="print-content-only app-default" >
    ...
    <div class="card-body py-20">
        ...
        <div class="mw-lg-950px mx-auto w-100">
            ...
            <div class="pb-12">
                ...
                <div class="d-flex flex-column gap-7 gap-md-10">
                    ...
                    <div class="fw-bold fs-2">
                        Dear Robert Doe <span class="fs-6">(robert@benko.com)</span>,<br />
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                        ...
                        <div class="flex-root d-flex flex-column">
                            ...
                            <span class="fs-5">27 June, 2023</span>
                        </div>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!--begin::Thumbnail-->
                                                <a href="../../ecommerce/catalog/edit-product.php" class="symbol symbol-50px">
            ...
            <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                ...
                <!-- begin::Action-->
                <a href="../create.php" class="btn btn-primary my-1">Create Invoice</a>
                <!-- end::Action-->
            </div>
            <!-- end::Footer-->
        </div>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="../create/main.php">
				Invoices			</a>
