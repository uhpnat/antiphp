...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary py-5 me-6 active" href="files.php">
                        Files                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
...
<div class="d-flex flex-wrap flex-stack my-5">
    ...
    <div class="d-flex my-2">
        ...
        <div class="d-flex align-items-center position-relative me-4">
            <i class="ki-outline ki-magnifier fs-3 position-absolute translate-middle-y top-50 ms-4"></i>            <input type="text" id="kt_filter_search" class="form-control form-control-sm form-control-solid bg-body fw-semibold fs-7 w-150px ps-11" placeholder="Search" />
        </div>
        <!--end::Search-->

        <a href="../file-manager/folders.php" class='btn btn-primary btn-sm fw-bolder'>File Manager</a>
    </div>
    <!--end::Controls-->
</div>
<!--end::Toolbar-->
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                ...
                <div class="card h-100 ">
                    ...
                    <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                        <!--begin::Name-->
                        <a href="../file-manager/files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
                            <!--begin::Image-->
