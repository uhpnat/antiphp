    ...
    <div class="card-body pt-0">
        ...
        <table class="table table-row-dashed fs-6 gy-5 my-0" id="kt_ecommerce_add_product_reviews">
            ...
            <tbody>
                        ...
                        <td>
                            <a href="../../inbox/reply.php" class="d-flex text-dark text-gray-800 text-hover-primary">
                                <!--begin::Avatar-->
