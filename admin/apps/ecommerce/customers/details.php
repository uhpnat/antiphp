...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-body pt-15">
        ...
        <div class="pb-5 fs-6">
                ...
                <div class="text-gray-600"><a href="../sales/details.php" class="text-gray-600 text-hover-primary">#14534</a> </div>
                <!--begin::Details item-->
                    </div>
        <!--end::Details content-->
    </div>
...
<div class="card pt-4 h-md-100 mb-6 mb-md-0">
    ...
    <div class="card-body pt-0">
        <div class="fw-bold fs-2">
            <div class="d-flex">
                <i class="ki-outline ki-heart text-info fs-2x"></i>                <div class="ms-2">
    ...
    <div class="card-body pt-0 pb-5">
        ...
        <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
            ...
            <tbody class="fs-6 fw-semibold text-gray-600">
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15372</a>
                        </td>
                        <td>
                        ...
                        <td>
                            14 Dec 2020, 8:43 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#14402</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            01 Dec 2020, 10:12 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15739</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            12 Nov 2020, 2:01 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15519</a>
                        </td>
                        <td>
                        ...
                        <td>
                            21 Oct 2020, 5:54 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15327</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            19 Oct 2020, 7:32 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#14804</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            23 Sep 2020, 12:38 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15787</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
                        ...
                        <td>
                            11 Sep 2020, 3:18 pm                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#15528</a>
                        </td>
                        <td>
                        ...
                        <td>
                            03 Sep 2020, 1:08 am                        </td>
                                    ...
                                    <tr>
                        <td>
                            <a href="../sales/details.php" class="text-gray-600 text-hover-primary mb-1">#14801</a>
                        </td>
                        <td>
                            <span class="badge badge-light-warning">Pending</span>
                        </td>
            ...
            <div class="py-0">
                ...
                <div class="py-3 d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_ecommerce_customer_addresses_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                        <!--begin::Arrow-->
                        <div class="me-3 rotate-90"><i class="ki-outline ki-right fs-3"></i></div>
                        <!--end::Arrow-->
                    ...
                    <div class="d-flex flex-wrap py-5">
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">**** 2868</td>
                                    </tr>
                                                                    <tr>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Passed <i class="ki-outline ki-check-circle fs-2 text-success"></i></td>
                                    </tr>
                                                                </table>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Melody Macy</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 4481</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">United Kingdom <div class="symbol symbol-20px symbol-circle ms-2"><img src="../../../assets/media/flags/united-kingdom.svg" /></div></td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">CVC check</td>
                                        <td class="text-gray-800">Passed <i class="ki-outline ki-check fs-2 text-success"></i></td>
                                    </tr>
                                                                </table>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Max Smith</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 8589</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                            ...
                            <div class="flex-equal ">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">United States of America <div class="symbol symbol-20px symbol-circle ms-2"><img src="../../../assets/media/flags/united-states.svg" /></div></td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">CVC check</td>
                                        <td class="text-gray-800">Failed <i class="ki-outline ki-cross fs-2 text-danger"></i></td>
                                    </tr>
                                                                </table>
                            </div>
                            <!--end::Col-->
