            ...
            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                <tbody class="fw-semibold text-gray-600">
                    <tr>
                        ...
                        <td class="fw-bold text-end">27/06/2023</td>
                    </tr>
                    <tr>
                        <td class="text-muted">
                            <div class="d-flex align-items-center">
            ...
            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                <tbody class="fw-semibold text-gray-600">
                    <tr>
                        ...
                        <td class="fw-bold text-end">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <!--begin::Name-->
                                <a href="../customers/details.php" class="text-gray-600 text-hover-primary">
                                    Dan Wilson                                </a>
                                <!--end::Name-->
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-end">
                            <a href="../../user-management/users/view.php" class="text-gray-600 text-hover-primary">
...
<span class="ms-1"  data-bs-toggle="tooltip" title="View the invoice generated by this order." >
	<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i></span>                            </div>
                        ...
                        <td class="fw-bold text-end"><a href="../../invoices/view/invoice-3.php" class="text-gray-600 text-hover-primary">#INV-000414</a></td>
                    </tr>
                    <tr>
                        <td class="text-muted">
                            <div class="d-flex align-items-center">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="ms-5">
                                    <a href="../catalog/edit-product.php" class="fw-bold text-gray-600 text-hover-primary">Product 1</a>
                                    <div class="fs-7 text-muted">Delivery Date: 27/06/2023</div>
                                </div>
                                <!--end::Title-->
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="ms-5">
                                    <a href="../catalog/edit-product.php" class="fw-bold text-gray-600 text-hover-primary">Footwear</a>
                                    <div class="fs-7 text-muted">Delivery Date: 27/06/2023</div>
                                </div>
                                <!--end::Title-->
                            </div>
