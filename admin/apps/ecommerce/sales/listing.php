...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <!--begin::Add product-->
            <a href="../catalog/add-product.php" class="btn btn-primary">
                Add Order
            </a>
            <!--end::Add product-->
        </div>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../../user-management/users/view.php">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Francis Mitcham</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Ethan Wilder</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Max Smith</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Sean Bean</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Ana Crown</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Neil Owen</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Melody Macy</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Olivia Wild</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Dan Wilson</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Mikaela Collins</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Lucy Kunic</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">John Miller</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Emma Bold</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Robert Doe</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Brian Cox</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
...
<!--end::Menu-->                </td>
                ...
                <td data-kt-ecommerce-order-filter="order_id">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-5">
                            <!--begin::Title-->
                            <a href="../../user-management/users/view.php" class="text-gray-800 text-hover-primary fs-5 fw-bold">Emma Smith</a>
                            <!--end::Title-->
                        </div>
                    </div>
                </td>
