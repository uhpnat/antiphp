    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>                <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Subscriptions" />
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
...
<!--end::Menu 1-->    <!--end::Filter-->
    ...
    <a href="add.php" class="btn btn-primary">
        <i class="ki-outline ki-plus fs-2"></i>        Add Subscription
    </a>
...
<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
    ...
    <tbody class="text-gray-600 fw-semibold">
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                </td>
                <td>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="add.php" class="menu-link px-3">
            View
        </a>
    </div>
    <!--end::Menu item-->
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                </td>
                <td>
                    <div class="badge badge-light-warning">Expiring</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                </td>
                <td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                </td>
                <td>
                    <div class="badge badge-light-warning">Expiring</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                </td>
                <td>
                    <div class="badge badge-light-danger">Suspended</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
...
<!--end::Menu-->
                ...
                <td>
                    <a href="../customers/view.php" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
                </td>
                <td>
                    <div class="badge badge-light-success">Active</div>
                </td>
