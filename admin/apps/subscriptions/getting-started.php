...
<div class="card ">
    ...
    <div class="card-body p-0">
        ...
        <div class="card-px text-center py-20 my-10">
            ...
            <!--begin::Action-->
            <a href="add.php" class="btn btn-primary">Add Subscription</a>
            <!--end::Action-->
        </div>
        <!--end::Wrapper-->
