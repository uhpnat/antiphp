...
<div class="card card-flush pt-3 mb-5 mb-lg-10">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-7 d-none">
            ...
            <a href="../customers/list.php" class="btn btn-light-primary">Add New Customer</a>
        </div>
                    ...
                    <div class="py-3 d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center collapsible toggle " data-bs-toggle="collapse" data-bs-target="#kt_create_new_payment_method_1">
                            ...
                            <div class="btn btn-sm btn-icon btn-active-color-primary ms-n3 me-2">
                                ...
                                <i class="ki-outline ki-plus-square toggle-off fs-2"></i>                            </div>
                            <!--end::Arrow-->
                        ...
                        <div class="d-flex flex-wrap py-5">
                                ...
                                <div class="flex-equal me-5">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">**** 2250</td>
                                        </tr>
                                                                            <tr>
                                ...
                                <div class="flex-equal me-5">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">Melody Macy</td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                            <td class="text-gray-800">**** 1438</td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                ...
                                <div class="flex-equal me-5">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">Max Smith</td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                            <td class="text-gray-800">**** 6664</td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Expires</td>
    ...
    <div class="card-body pt-0">
        ...
        <div class="d-flex flex-column mb-5 fv-row rounded-3 p-7 border border-dashed border-gray-300">
            ...
            <div class="fs-5 fw-bold form-label mb-3">
                ...
                <span class="ms-2 cursor-pointer" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-html="true" data-bs-delay-hide="1000"
    ...
    <div class="card-body pt-0 fs-6">
        ...
        <div class="mb-7">
            ...
            <div class="d-flex align-items-center mb-1">
                <!--begin::Name-->
                <a href="../customers/view.php" class="fw-bold text-gray-800 text-hover-primary me-2">
                    Sean Bean                </a>
                <!--end::Name-->
