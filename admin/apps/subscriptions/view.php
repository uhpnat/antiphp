...
<div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <a href="add.php" class="btn btn-light-primary">Update Product</a>
        </div>
        <!--end::Card toolbar-->
    </div>
    <!--end::Card header-->
                    ...
                    <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                        ...
                        <tr>
                            ...
                            <td class="text-gray-800 min-w-200px">
                                <a href="../../pages/apps/customers/view.php" class="text-gray-800 text-hover-primary">smith@kpmg.com</a>
                            </td>
                        </tr>
                        <!--end::Row-->
            ...
            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                <tbody>
                            ...
                            <td class="min-w-400px">
                                <a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">Sean Bean</a> has made payment to <a href="#" class="fw-bold text-gray-800 text-hover-primary">4703-9503</a> 
                            </td>
                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                21 Feb 2023, 5:20 pm                            </td>
                                            ...
                                            <tr>
                            <td class="min-w-400px">
                                Invoice <a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">2745-6134</a> status has changed from <span class="badge badge-light-warning me-1">Pending</span> to <span class="badge badge-light-info">In Progress</span> 
                            </td>
                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                22 Sep 2023, 6:43 am                            </td>
                                            ...
                                            <tr>
                            <td class="min-w-400px">
                                Invoice <a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">2085-6335</a> is <span class="badge badge-light-info">In Progress</span> 
                            </td>
                            <td class="pe-0 text-gray-600 text-end min-w-200px">
                                10 Mar 2023, 11:05 am                            </td>
                                            ...
                                            <tr>
                            <td class="min-w-400px">
                                <a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">Max Smith</a> has made payment to <a href="#" class="fw-bold text-gray-800 text-hover-primary">1702-7211</a> 
                            </td>
                            <td class="pe-0 text-gray-600 text-end min-w-200px">
...
<!--end::Menu-->
    ...
    <div class="card-body pt-0 fs-6">
        ...
        <!--begin::Actions-->
        <div class="mb-0">
            <a href="add.php"  class="btn btn-primary" id="kt_subscriptions_create_button">                
                Edit Subscription
            </a>
        </div>
        <!--end::Actions-->
