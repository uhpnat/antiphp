            ...
            <div class="d-flex flex-wrap flex-center">
                ...
                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                    <div class="fs-4 fw-bold text-gray-700">
                        ...
                        <i class="ki-outline ki-arrow-up fs-3 text-success"></i>                    </div>
                ...
                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
                    <div class="fs-4 fw-bold text-gray-700">
                        ...
                        <i class="ki-outline ki-arrow-down fs-3 text-danger"></i>                    </div>
    ...
    <div class="card-body pt-0 pb-5">
        ...
        <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
            ...
            <tbody class="fs-6 fw-semibold text-gray-600">
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">6539-9599</a>
                        </td>
                        <td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">5791-3629</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">6559-6489</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">8091-4981</a>
                        </td>
                        <td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">5393-5654</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">7120-2105</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">5631-7189</a>
                        </td>
                        <td>
                            <span class="badge badge-light-success">Successful</span>
                        </td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">8604-1423</a>
                        </td>
                        <td>
...
<!--end::Menu-->
                                    ...
                                    <tr>
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">4727-2631</a>
                        </td>
                        <td>
                            <span class="badge badge-light-warning">Pending</span>
                        </td>
                    ...
                    <div class="d-flex flex-wrap py-5">
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">**** 3081</td>
                                    </tr>
                                                                    <tr>
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Melody Macy</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 6228</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                            ...
                            <div class="flex-equal me-5">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">Max Smith</td>
                                                                    ...
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                        <td class="text-gray-800">**** 2752</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Expires</td>
    ...
    <div class="card-header border-0">
        ...
        <div class="card-toolbar">
            <a href="#" class="btn btn-sm btn-flex btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_adjust_balance">
                <i class="ki-outline ki-pencil fs-3"></i>                Adjust Balance
            </a>
        </div>
        <!--end::Card toolbar-->
    </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
                <tbody>
                            ...
                            <td>
                               POST /v1/customer/c_649b19155f379/not_found                            </td>
                            ...
                            <td>
                               POST /v1/invoices/in_8794_2999/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoices/in_3587_8002/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoice/in_6552_4442/invalid                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoice/in_7325_5600/invalid                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoices/in_4467_4987/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/customer/c_649b19155f37b/not_found                            </td>
                            <td class="pe-0 text-end min-w-200px">
