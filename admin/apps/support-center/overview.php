            ...
            <div class="card-body p-10 p-lg-15">
                ...
                <div class="d-flex flex-stack mb-7">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Arrow-->
                        <i class="ki-outline ki-arrow-right fs-2 text-primary"></i>                        <!--end::Arrow-->
                    </div>
                    <!--end::Section-->
                </div>
                <!--end::Header-->
    ...
    <div class="m-0">
        ...
        <div class="d-flex align-items-center collapsible py-3 toggle  mb-0" data-bs-toggle="collapse" data-bs-target="#kt_support_1_1">
            ...
            <div class="ms-n1 me-5">              
                ...
                <i class="ki-outline ki-right toggle-off fs-2"></i>            </div>
            <!--end::Icon-->
        ...
        <div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
            ...
            <div class="card-body p-10 p-lg-15">
                ...
                <div class="d-flex flex-stack mb-7">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Link-->
                        <a href="tutorials/list.php" class="text-primary fw-bold me-1">All Tutorials</a>
                        <!--begin::Link-->
