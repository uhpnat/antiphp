...
<div class="mb-17">
    ...
    <div class="mb-8">  
        ...
        <div class="overlay mt-8">    
            ...
            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                ...
                <a href="../../../pages/careers/apply.php" class="btn btn-light-primary ms-3">Join Us</a>
            </div> 
            <!--end::Links-->   
        </div>  
        <!--end::Container-->  
    ...
    <div class="fs-5 fw-semibold text-gray-600"> 
        ...
        <p class="mb-8"> 
            ...
            <a href="../../../pages/blog/post.php" class="link-primary pe-1">Your Post</a> 
        ...
        <p class="mb-8"> 
            ...
            <a href="../../../pages/blog/home.php" class="link-primary pe-1">I mean NOTHING</a> 
    ...
    <div class="d-flex align-items-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
        ...
        <div class="text-center flex-shrink-0 me-7 me-lg-13">
            ...
            <!--begin::Info-->
            <div class="mb-0">
                <a href="../../../pages/user-profile/overview.php" class="text-gray-700 fw-bold text-hover-primary">Jane Johnson</a>
        ...
        <div class="mb-0 fs-6"> 
            ...
            <a href="../../../pages/user-profile/overview.php" class="fw-semibold link-primary">Author’s Profile</a>              
        </div>
        <!--end::Text-->
    </div>
    <!--end::Block-->   
...
<div class="card-xl-stretch me-md-6">    
    ...
    <div class="m-0">    
        <!--begin::Title-->
        <a href="../../../pages/user-profile/overview.php" class="fs-4 text-dark fw-bold text-hover-primary text-dark lh-base">
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../../../pages/user-profile/overview.php" class="text-gray-700 text-hover-primary">Jane Miller</a>
            <!--end::Author-->
...
<div class="card-xl-stretch mx-md-3">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../../../pages/user-profile/overview.php" class="text-gray-700 text-hover-primary">Cris Morgan</a>
            <!--end::Author-->
...
<div class="card-xl-stretch ms-md-6">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../../../pages/user-profile/overview.php" class="text-gray-700 text-hover-primary">Carles Nilson</a>
            <!--end::Author-->
