...
<div class="mb-0">
    ...
    <div class="mb-15"> 
        ...
        <div class="mb-15 fs-5 fw-normal text-gray-800"> 
            ...
            <!--begin::Code-->
            <div class="mb-10">
                <!--begin::Highlight--><div class="highlight">  <button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button><ul class="nav nav-pills" role="tablist"><li class="nav-item">    <a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_649b190f62c0a" role="tab">JAVASCRIPT</a></li><li class="nav-item">    <a class="nav-link " data-bs-toggle="tab" href="#kt_highlight_649b190f62c0e" role="tab">HTML</a></li></ul><div class="tab-content"><div class="tab-pane fade show active" id="kt_highlight_649b190f62c0a" role="tabpanel">    <div class="highlight-code"><pre class="language-javascript"   ><code class="language-javascript">// Element to indecate
...
});</code></pre>    </div></div><div class="tab-pane fade " id="kt_highlight_649b190f62c0e" role="tabpanel">    <div class="highlight-code"><pre class="language-html"   ><code class="language-html">&lt;button type=&quot;button&quot; class=&quot;btn btn-primary me-10&quot; id=&quot;kt_button_1&quot;&gt;
        ...
        <div class="w-100 d-flex flex-stack mb-8">
            ...
            <div class="d-flex align-items-center f">
                ...
                <div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">    
                    ...
                    <div class="d-flex align-items-center">    
                        <!--begin::Username-->
                        <a href="../../../pages/user-profile/overview.php" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Sandra Piquet</a>
                        <!--end::Username-->
        ...
        <div class="w-100 d-flex flex-stack mb-8">
            ...
            <div class="d-flex align-items-center f">
                ...
                <div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">    
                    ...
                    <div class="d-flex align-items-center">    
                        <!--begin::Username-->
                        <a href="../../../pages/user-profile/overview.php" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Bob Clarcson</a>
                        <!--end::Username-->
        ...
        <div class="w-100 d-flex flex-stack mb-8">
            ...
            <div class="d-flex align-items-center f">
                ...
                <div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">    
                    ...
                    <div class="d-flex align-items-center">    
                        <!--begin::Username-->
                        <a href="../../../pages/user-profile/overview.php" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Matthew</a>
                        <!--end::Username-->
        ...
        <div class="overflow-hidden position-relative card-rounded"> 
            ...
            <div class="ribbon ribbon-triangle ribbon-top-start border-success">
                ...
                <div class="ribbon-icon mt-n5 ms-n6">
                    <i class="ki-outline ki-check fs-1 text-white mt-n1"></i>                </div>
                <!--end::Ribbon icon-->
            </div>
            <!--end::Ribbon-->
        ...
        <div class="w-100 d-flex flex-stack mb-8">
            ...
            <div class="d-flex align-items-center f">
                ...
                <div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">    
                    ...
                    <div class="d-flex align-items-center">    
                        <!--begin::Username-->
                        <a href="../../../pages/user-profile/overview.php" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Boris</a>
                        <!--end::Username-->
            ...
            <div class="m-0">
                    ...
                    <button type="button" class="btn btn-sm btn-icon btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-end">
                        <i class="ki-outline ki-dots-square fs-1"></i>                    </button>
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="../overview/main.php">
				Support Center			</a>
