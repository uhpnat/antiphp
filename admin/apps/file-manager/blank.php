        ...
        <div class="d-flex flex-stack">
            ...
            <div class="badge badge-lg badge-light-primary">
                <div class="d-flex align-items-center flex-wrap">
                    <i class="ki-outline ki-abstract-32 fs-2 text-primary me-3"></i>                    <a href="folders.php">Keenthemes</a>
                    <i class="ki-outline ki-right fs-2 text-primary mx-1"></i>                    <a href="folders.php">themes</a>
                    <i class="ki-outline ki-right fs-2 text-primary mx-1"></i>                    <a href="folders.php">html</a>
