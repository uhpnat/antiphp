...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo30/../demo30/authentication/layouts/corporate/sign-in.html" action="#">
    <!--begin::Heading-->
