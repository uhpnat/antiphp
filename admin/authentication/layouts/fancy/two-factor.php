...
<!--begin::Form-->
<form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="/metronic8/demo30/../demo30/index.html" id="kt_sing_in_two_factor_form">
    <!--begin::Icon-->
...
<!--end::Authentication - Two-factor--></div>
<!--end::Root-->
