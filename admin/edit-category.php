                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_content" class="app-content ">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $editCat = $cat->update_category($catName, $id);
                            echo  $editCat;
                        }
                        if (isset($_GET['edit'])) {
                            $id = $_GET['edit'];
                            $show = $cat->show_category_one($id);
                        }
                        ?>
                        ...
                        <form method="post" action="" class="form d-flex flex-column flex-lg-row">
                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="category_name" class="form-control mb-2" placeholder="" value="<?php echo $show[0]['categoryName']; ?>" />
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                </div>
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="categories.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">
                                        Cancel
                                    </a>
                                    <!--end::Button-->
