...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
    ...
    if(isset($_GET['id'])){
        ...
        foreach($data as $value){
            ...
            $cart = json_decode($value['product'], true);
        }
        // var_dump($totalPrice);
    }
    if(isset($_POST["handleSubmit"]) && ($_POST["handleSubmit"])){
        ...
        $order->update_order_id($code, $address, $email, $phone, $name, $status, $id);
        
        echo '<script type="text/javascript">toastr.success("Lưu thành công")</script>';
                                                ...
                                                <div class="d-flex flex-column gap-10">
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <div class="fw-bold fs-3">
                                                            #<?php if(isset($orderId)){echo $orderId;} ?></div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="fv-row">
                                                        <!--begin::Label-->
                                                        <label class="required form-label">Phương thức thanh
                                                            toán</label>
                                                        <!--end::Label-->
                                                    ...
                                                    <div class="fv-row">
                                                        <!--begin::Label-->
                                                        <label class="required form-label">Phương thức giao hàng</label>
                                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card card-flush py-4">
                                                ...
                                                <div class="d-flex flex-column gap-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll"
                                                            ...
                                                            <!--begin::Empty message-->
                                                            <span class="w-100 text-muted d-none">Select one or more
                                                                products from the list below by ticking the
                                                                checkbox.</span>
                                                            <!--end::Empty message-->
                                                            <?php 
                                                                    if(isset($cart)){
                                                                        foreach($cart['results'] as $item){
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="../catalog/edit-product.html"
                                                                        ...
                                                                        <span class="symbol-label"
                                                                            style="background-image:url(assets/media/imageproduct/<?php echo $item['image'] ?>);"></span>
                                                                    </a>
                                                                    <!--end::Thumbnail-->
                                                                    ...
                                                                    <div class="ms-5">
                                                                        ...
                                                                        <!--begin::SKU-->
                                                                        <div class="text-muted fs-7">Số lượng:
                                                            ...
                                                            <div class="fw-bold fs-4">
                                                                ...
                                                                <span id="kt_ecommerce_edit_order_total_price">
                                                                    <?php if(isset($totalPrice)){echo number_format($totalPrice).' vnđ' ;}?>
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="d-flex flex-column gap-5 gap-md-7">
                                                      ...
                                                      ?>
                                                        <!--begin::Title-->
                                                        <div class="fs-3 fw-bold mb-n2">Thông tin</div>
                                                        <!--end::Title-->
                                                        ...
                                                        <div class="fv-row">
                                                            ...
                                                            <div class="mb-7">
                                                                <!--begin::Label-->
                                                                <label
                                                                    class="required fw-semibold fs-6 mb-5">Trạng thái</label>
                                                                <!--end::Label-->
                                                                ...
                                                                <div class="d-flex fv-row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input me-3" name="status"
                                                                            type="radio" value="0"
                                                                            id="kt_modal_update_role_option_0" <?php if($value['status'] == 0){
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            ...
                                                                            <div class="fw-bold text-gray-800">
                                                                                Chưa nhận</div>
                                                                            <div class="text-gray-600">Sản phẩm chưa giao hàng thành chông</div>
                                                                        </label>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Radio-->
                                                                ...
                                                                <div class="d-flex fv-row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input me-3" name="status"
                                                                            type="radio" value="1"
                                                                            id="kt_modal_update_role_option_1" <?php if($value['status'] == 1){
                                                                                        echo"checked='checked'";
                                                                                    } ?> />
                                                                        <!--end::Input-->
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            ...
                                                                            <div class="fw-bold text-gray-800">
                                                                                Đã nhận</div>
                                                                            <div class="text-gray-600">Sản phẩm đã được giao thành công</div>
                                                                        </label>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Radio-->
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <!--begin::Button-->
                                                <input class="btn btn-primary" type="submit" value="Lưu thay đổi" name="handleSubmit">
