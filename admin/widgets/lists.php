...
<div class="row">
    ...
    <div class="col-lg-4 mb-6 mb-lg-0">
            ...
            <div class="menu-item p-0 m-0">
                <!--begin:Menu link-->
                <a href="lists.php" class="menu-link active">
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b19073e819">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b19073e819" data-allow-clear="true">
                    <option></option>
...
<!--end::Menu 1-->            <!--end::Menu-->
    ...
    <div class="card-body pt-5">
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                    <span class="symbol-label bg-light-success">
                        <i class="ki-outline ki-abstract-26 fs-2x text-success"></i>                    </span>                
                </div>
                <!--end::Symbol-->
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                    <span class="symbol-label bg-light-warning">
                        <i class="ki-outline ki-pencil fs-2x text-warning"></i>                    </span>                
                </div>
                <!--end::Symbol-->
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                    <span class="symbol-label bg-light-primary">
                        <i class="ki-outline ki-message-text-2 fs-2x text-primary"></i>                    </span>                
                </div>
                <!--end::Symbol-->
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                    <span class="symbol-label bg-light-danger">
                        <i class="ki-outline ki-disconnect fs-2x text-danger"></i>                    </span>                
                </div>
                <!--end::Symbol-->
            ...
            <div class="d-flex align-items-center ">
                ...
                <div class="symbol symbol-50px me-5">
                    <span class="symbol-label bg-light-info">
                        <i class="ki-outline ki-security-user fs-2x text-info"></i>                    </span>                
                </div>
                <!--end::Symbol-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b19073e8c1">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b19073e8c1" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b19073e905">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b19073e905" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
                ...
                <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
                    ...
                    <div class="d-flex align-items-center">                        
                        ...
                        <a href="#" class="btn btn-icon btn-light btn-sm border-0">
                            <i class="ki-outline ki-arrow-right fs-2 text-primary"></i>                        </a>                        
                    </div>
                    <!--end::Section-->
                </div>
                <!--end::Content--> 
    ...
    <div class="card-header align-items-center border-0 mt-3">
        ...
        <div class="card-toolbar">
            ...
            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-primary btn-active-light-primary me-n3" 
                ...
                <i class="ki-outline ki-category fs-6 text-primary"></i>            </button>
