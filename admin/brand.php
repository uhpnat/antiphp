                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-brand.html" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-brand-filter="brand_name"><?php echo $item['brandName'] ?>
                                                    </td>
                                                    <td>
                                                        <!--begin::Badges-->
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="edit-brand.php?edit=<?php echo $item['brandId'] ?>" class="menu-link px-3">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            ...
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="?delete=<?php echo $item['brandId'] ?>" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row">
                                                                    Delete
                                                                </a>
                                                            </div>
                                                            <!--end::Menu item-->
