...
<div class="app-content-menu menu menu-rounded menu-gray-800 menu-state-bg flex-wrap fs-5 fw-semibold border-bottom mt-n7 pt-5 pb-6 px-10 mb-10">
		...
		<div class="menu-item pe-2">
			<a class="menu-link px-5 active" href="index.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/projects/list.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/user-management/users/list.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/subscriptions/list.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/customers/list.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/ecommerce/catalog/products.php">
		...
		<!--end::Menu item-->
			<!--begin::Menu item-->
		<div class="menu-item pe-2">
			<a class="menu-link px-5 " href="apps/file-manager/folders.php">
