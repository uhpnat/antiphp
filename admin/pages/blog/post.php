            ...
            <div class="col-lg-3 mb-6 mb-lg-0"> 
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="post.php" class="menu-link active">
...
<div class="mb-17">
    ...
    <div class="mb-8">  
        ...
        <div class="d-flex flex-wrap mb-6">
            ...
            <div class="me-9 my-1">
                <!--begin::Icon-->
                <i class="ki-outline ki-element-11 text-primary fs-2 me-1"></i>                <!--end::Icon-->
            ...
            <div class="me-9 my-1">
                <!--begin::Icon-->
                <i class="ki-outline ki-briefcase text-primary fs-2 me-1"></i>                <!--end::Icon-->
            ...
            <div class="my-1">
                <!--begin::Icon-->
                <i class="ki-outline ki-message-text-2 text-primary fs-2 me-1"></i>                <!--end::Icon-->
    ...
    <div class="fs-5 fw-semibold text-gray-600"> 
        ...
        <p class="mb-8"> 
            ...
            <a href="post.php" class="link-primary pe-1">Your Post</a> 
        ...
        <p class="mb-8"> 
            ...
            <a href="home.php" class="link-primary pe-1">I mean NOTHING</a> 
    ...
    <div class="d-flex align-items-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
        ...
        <div class="text-center flex-shrink-0 me-7 me-lg-13">
            ...
            <!--begin::Info-->
            <div class="mb-0">
                <a href="../user-profile/overview.php" class="text-gray-700 fw-bold text-hover-primary">Jane Johnson</a>
        ...
        <div class="mb-0 fs-6"> 
            ...
            <a href="../user-profile/overview.php" class="fw-semibold link-primary">Author’s Profile</a>              
        </div>
        <!--end::Text-->
    </div>
    <!--end::Block-->   
...
<div class="card-xl-stretch me-md-6">    
    ...
    <div class="m-0">    
        <!--begin::Title-->
        <a href="../user-profile/overview.php" class="fs-4 text-dark fw-bold text-hover-primary text-dark lh-base">
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../user-profile/overview.php" class="text-gray-700 text-hover-primary">Jane Miller</a>
            <!--end::Author-->
...
<div class="card-xl-stretch mx-md-3">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../user-profile/overview.php" class="text-gray-700 text-hover-primary">Cris Morgan</a>
            <!--end::Author-->
...
<div class="card-xl-stretch ms-md-6">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../user-profile/overview.php" class="text-gray-700 text-hover-primary">Carles Nilson</a>
            <!--end::Author-->
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="home.php">
						Blog Home					</a>
					...
					<a class="fw-6 fw-semibold" href="post.php">
						Blog Post					</a>
