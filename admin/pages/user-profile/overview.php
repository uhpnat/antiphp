        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="followers.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="activity.php" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../sitemap.php" class="menu-link ">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../careers/list.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../careers/apply.php" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0"> 
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../faq/classic.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../faq/extended.php" class="menu-link ">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../blog/home.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../blog/post.php" class="menu-link ">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../pricing/column.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../pricing/table.php" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../social/feeds.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../social/activity.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../social/followers.php" class="menu-link ">
                                <span class="menu-title">Followers</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../social/settings.php" class="menu-link ">
...
<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
    ...
    <div class="d-flex justify-content-end">
        ...
        <a href="../search/horizontal.php" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
    </div>
    <!--end::Actions-->
</form>
<!--end::Preferences-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
 ...
 fs-2 text-info"></i>                                                    
			...
			<div class="py-3 text-center border-top">
                <a href="activity.php" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All 
...
<!--end::Menu 3-->
                    ...
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <!--begin::Number-->
                                <div class="d-flex align-items-center">
                                    <i class="ki-outline ki-arrow-up fs-3 text-success me-2"></i>                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="$">0</div>
                                </div>
                                <!--end::Number-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <!--begin::Number-->
                                <div class="d-flex align-items-center">
                                    <i class="ki-outline ki-arrow-down fs-3 text-danger me-2"></i>                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="80">0</div>
                                </div>
                                <!--end::Number-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <!--begin::Number-->
                                <div class="d-flex align-items-center">
                                    <i class="ki-outline ki-arrow-up fs-3 text-success me-2"></i>                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="60" data-kt-countup-prefix="%">0</div>
                                </div>
                                <!--end::Number-->                                
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="overview.php">
                        Overview                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="projects.php">
                        Projects                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="campaigns.php">
                        Campaigns                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="documents.php">
                        Documents                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="followers.php">
                        Followers                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="activity.php">
                        Activity                    </a>
                </li>
                <!--end::Nav item-->
                    </ul>
            ...
            <div id="kt_forms_widget_1_editor_toolbar" class="ql-toolbar d-flex flex-stack py-2">
                ...
                <div class="me-n3">
                    <span class="btn btn-icon btn-sm btn-active-color-primary">
                        <i class="ki-outline ki-paper-clip fs-2"></i>                    </span>
                    
                    <span class="btn btn-icon btn-sm btn-active-color-primary">
                        <i class="ki-outline ki-geolocation fs-2"></i>                    </span>
                </div>
            </div>
            <!--end::Toolbar-->
        </form>
        ...
        <div class="mb-5">
            ...
            <div class="d-flex align-items-center mb-5">    
                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                    <i class="ki-outline ki-message-text-2 fs-2"></i>                    120
                </a>

                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
                    <i class="ki-outline ki-heart fs-2"></i>                    15
                </a>
            </div>
            <!--end::Toolbar-->
        </div>
        ...
        <form class="position-relative mb-6">
            ...
            <div class="position-absolute top-0 end-0 me-n5">                          
                <span class="btn btn-icon btn-sm btn-active-color-primary pe-0 me-2">
                    <i class="ki-outline ki-paper-clip fs-2 mb-3"></i>				</span>
                
				<span class="btn btn-icon btn-sm btn-active-color-primary ps-0">
                    <i class="ki-outline ki-geolocation fs-2 mb-3"></i>				</span>
            </div>
        </form>
        <!--edit::Reply input-->
    </div>
...
<!--end::Menu 2-->
        ...
        <div class="mb-7">
            ...
            <div class="d-flex align-items-center mb-5">    
                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                    <i class="ki-outline ki-message-text-2 fs-2"></i>                    12
                </a>

                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
                    <i class="ki-outline ki-heart fs-2"></i>                    150
                </a>
            </div>
            <!--end::Toolbar-->
        </div>
...
<!--end::Menu 3-->
        ...
        <div class="mb-7">
            ...
            <div class="d-flex align-items-center mb-5">    
                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                    <i class="ki-outline ki-message-text-2 fs-2"></i>                    22
                </a>

                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
                    <i class="ki-outline ki-heart fs-2"></i>                    59
                </a>
            </div>
            <!--end::Toolbar-->
        </div>
...
<!--end::Menu 2-->
        ...
        <div class="mb-7">
            ...
            <div class="d-flex align-items-center mb-5">    
                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                    <i class="ki-outline ki-message-text-2 fs-2"></i>                    20
                </a>

                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
                    <i class="ki-outline ki-heart fs-2"></i>                    50
                </a>
            </div>
            <!--end::Toolbar-->
        </div>
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b18eed0e82">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b18eed0e82" data-allow-clear="true">
                    <option></option>
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_649b18eed0eab">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_649b18eed0eab" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<!--end::Timeline item--> 				</div>
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="activity.php" class="btn btn-bg-body text-primary">
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="campaigns.php">
						User Campaigns					</a>

											
				
					<a class="fw-6 fw-semibold" href="documents.php">
						User Documents					</a>
					...
					<a class="fw-6 fw-semibold" href="followers.php">
						User Followers					</a>

											
				
					<a class="fw-6 fw-semibold" href="activity.php">
						User Activity					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="../about.php">
						About Us					</a>

											
				
					<a class="fw-6 fw-semibold" href="../contact.php">
						Contact Us					</a>
					...
					<a class="fw-6 fw-semibold" href="../licenses.php">
						License					</a>

											
				
					<a class="fw-6 fw-semibold" href="../team.php">
						Our Team					</a>
					...
					<a class="fw-6 fw-semibold" href="../sitemap.php">
						Sitemap					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="../social/feeds.php">
						Activity					</a>
					...
					<a class="fw-6 fw-semibold" href="../social/activity.php">
						Feeds					</a>
					...
					<a class="fw-6 fw-semibold" href="../social/followers.php">
						Followers					</a>
					...
					<a class="fw-6 fw-semibold" href="../social/settings.php">
						Settings					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="../faq/classic.php">
						FAQ Classic					</a>
					...
					<a class="fw-6 fw-semibold" href="../faq/extended.php">
						FAQ Extended					</a>
					...
					<a class="fw-6 fw-semibold" href="../blog/home.php">
						Blog Home					</a>
					...
					<a class="fw-6 fw-semibold" href="../blog/post.php">
						Blog Post					</a>
