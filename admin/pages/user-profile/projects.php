        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="projects.php" class="menu-link active">
...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="projects.php">
                        Projects                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
...
<!--begin::Card-->
<a href="../../apps/projects/project.php" class="card border-hover-primary ">
    <!--begin::Card header-->
