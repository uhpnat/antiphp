        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="documents.php" class="menu-link active">
...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="documents.php">
                        Documents                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
...
<div class="d-flex flex-wrap flex-stack mb-6">
    ...
    <div class="d-flex my-2">
        ...
        <a href="../../apps/file-manager/files.php" class="btn btn-primary btn-sm">
            File Manager
        </a>
    </div>
    <!--end::Controls-->
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                ...
                <div class="card h-100 ">
                    ...
                    <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                        <!--begin::Name-->
                        <a href="../../apps/file-manager/files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
                            <!--begin::Image-->
