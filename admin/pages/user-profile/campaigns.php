        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="campaigns.php" class="menu-link active">
...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="overview.php">
                        Overview                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="campaigns.php">
                        Campaigns                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
            ...
            <div class="card-header flex-nowrap border-0 pt-9">
                ...
                <div class="card-toolbar m-0">
                    ...
                    <button 
                        ...
                        <i class="ki-outline ki-element-plus fs-3 text-primary"></i>                    </button>
...
<span class="ms-1"  data-bs-toggle="tooltip" title="Recurring" >
	<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i></span>                                    </div>
                <!--end::Indicator-->
            </div>
            <!--end::Card body-->
        </div>
