        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <!--end:Menu heading-->
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/overview.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/projects.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/campaigns.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/documents.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/followers.php" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="../user-profile/activity.php" class="menu-link ">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="feeds.php" class="menu-link active">
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
 ...
 fs-2 text-info"></i>                                                    
			...
			<div class="py-3 text-center border-top">
                <a href="../user-profile/activity.php" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All 
    ...
    <div class="card-body pt-15 px-0">
        ...
        <div class="d-flex flex-column text-center mb-9 px-9">
            ...
            <div class="text-center">
                <!--begin::Name-->
                <a href="../user-profile/overview.php" class="text-gray-800 fw-bold text-hover-primary fs-4">Jerry Kane</a>
                <!--end::Name-->
        ...
        <div class="m-0">
            ...
            <ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="feeds.php">
                    ...
                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="activity.php">
                    ...
                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="followers.php">
                    ...
                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="settings.php">
...
<div class="card card-flush mb-10">
    ...
    <div class="card-footer d-flex justify-content-end pt-0">
        <!--begin::Post action-->
        <a href="../blog/post.php" class="btn btn-sm btn-primary" id="kt_social_feeds_post_btn">
            ...
            <ul class="nav py-3">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4 me-1">
                        <i class="ki-outline ki-heart fs-2 me-1"></i>
                                                    47k Likes
                                            </a>
                </li>
                <!--end::Item-->
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4"> 
                        ...
                        <i class="ki-outline ki-bookmark fs-2 me-1"></i>                        
                                                    900 Saves
                                            </a>
                </li>
                <!--end::Item-->
            ...
            <div class="position-relative w-100">
                ...
                <div class="position-absolute top-0 end-0 translate-middle-x mt-1 me-n14">   
                    ...
                    <button class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0">
                        <i class="ki-outline ki-paper-clip fs-2"></i>                    </button>
                    <!--end::Btn-->
                    
                    <!--begin::Btn-->
                    <button class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0">
                        <i class="ki-outline ki-like fs-2"></i>                    </button>
                    <!--end::Btn-->
                    
                    <!--begin::Btn-->
                    <button class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0">
                        <i class="ki-outline ki-badge fs-2"></i>                    </button>
                    <!--end::Btn-->
                    
                    <!--begin::Btn-->
                    <button class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0">
                        <i class="ki-outline ki-geolocation fs-2"></i>                    </button>
                    <!--end::Btn-->
                </div>
                <!--end::Actions-->
            </div>
    ...
    <div class="card-header pt-9">
        ...
        <div class="d-flex align-items-center">      
            ...
            <div class="symbol symbol-50px me-5">
                        ...
                        <i class="ki-outline ki-file-added fs-2x text-primary"></i>                    </div>                
    ...
    <div class="card-body pt-5">
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="../user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Jacob Jones</a>
                    ...
                    <!--begin:Action-->
                    <a href="../user-profile/overview.php" class="btn btn-sm btn-light fs-8 fw-bold">Follow</a>
                    <!--end:Action-->
                </div>
                <!--end::Section-->
            </div>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Annette Black</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Devon Lane</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Kristin Watson</a>
            ...
            <div class="d-flex flex-stack">  
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <!--begin:Author-->                    
                    <div class="flex-grow-1 me-2">
                        <a href="../user-profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Eleanor Pena</a>
...
<div class="card card-flush mb-5 mb-xl-8">
    ...
    <div class="card-header pt-5">
        ...
        <!--begin::Toolbar-->
        <div class="card-toolbar">   
            <a href="activity.php" class="btn btn-sm btn-light">View All</a>             
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
...
<!--end::Timeline item--> 				</div>
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="../user-profile/activity.php" class="btn btn-bg-body text-primary">
...
<!--begin::Preview-->
<a 
	href="../user-profile/overview.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../user-profile/projects.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../user-profile/campaigns.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../user-profile/documents.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../user-profile/followers.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../user-profile/activity.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="../user-profile/overview.php">
						Profile Overview					</a>

											
				
					<a class="fw-6 fw-semibold" href="../user-profile/projects.php">
						User Projects					</a>
					...
					<a class="fw-6 fw-semibold" href="../user-profile/campaigns.php">
						User Campaigns					</a>

											
				
					<a class="fw-6 fw-semibold" href="../user-profile/documents.php">
						User Documents					</a>
					...
					<a class="fw-6 fw-semibold" href="../user-profile/followers.php">
						User Followers					</a>

											
				
					<a class="fw-6 fw-semibold" href="../user-profile/activity.php">
						User Activity					</a>
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="feeds.php">
						Activity					</a>
