            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="followers.php" class="menu-link active">
                                <span class="menu-title">Followers</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
        ...
        <div class="m-0">
            ...
            <ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 " href="feeds.php">
                    ...
                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                    <li class="nav-item mt-5">
                        <a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="followers.php">
