            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="about.php" class="menu-link active">
...
<div class="mb-18">
    ...
    <div class="mb-10">          
        ...
        <div class="overlay">    
            ...
            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                <a href="pricing/pricing-2.php" class="btn btn-primary">Pricing</a>
    ...
    <div class="fs-5 fw-semibold text-gray-600"> 
        ...
        <p class="mb-8"> 
            ...
            <a href="blog/home.php" class="link-primary pe-1">I mean NOTHING</a> 
...
<div class="card-xl-stretch me-md-6">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../apps/projects/users.php" class="text-gray-700 text-hover-primary">Jane Miller</a>
            <!--end::Author-->
...
<div class="card-xl-stretch mx-md-3">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../apps/projects/users.php" class="text-gray-700 text-hover-primary">Cris Morgan</a>
            <!--end::Author-->
...
<div class="card-xl-stretch ms-md-6">    
    ...
    <div class="m-0">    
        ...
        <div class="fs-6 fw-bold">
            <!--begin::Author-->
            <a href="../apps/projects/users.php" class="text-gray-700 text-hover-primary">Carles Nilson</a>
            <!--end::Author-->
...
<div class="mb-18">        
    ...
    <div class="tns tns-default mb-10">
        ...
        <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_prev">
            <i class="ki-outline ki-left fs-3x"></i>        </button>
        <!--end::Button-->

        <!--begin::Button-->
        <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_next">
            <i class="ki-outline ki-right fs-3x"></i>        </button>
        <!--end::Button-->
    </div>
    <!--end::Slider-->     
</div>
