            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="apply.php" class="menu-link active">
...
<div class="position-relative mb-17">
    ...
    <div class="overlay overlay-show">    
        <!--begin::Image-->   
        <div 
            class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-250px"
...
<!--begin::Form-->
<form action="https://preview.keenthemes.com/metronic8/demo30/pages/careers/m-0" class="form mb-15" method="post" id="kt_careers_form">
    <!--begin::Input group-->
    <div class="row mb-5">
        <!--begin::Col-->
...
<div class="card bg-light ">
    ...
    <div class="card-body">
        ...
        <!--begin::Link-->
        <a href="../blog/post.php" class="link-primary fs-6 fw-semibold">Explore More</a>
        <!--end::Link-->
    </div>
    <!--end::Body-->
</div>
