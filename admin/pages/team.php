...
<div class="mb-18">
    ...
    <div class="mb-11">          
        ...
        <div class="overlay">    
            ...
            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                <a href="pricing/pricing-1.php" class="btn btn-primary">Pricing</a>
                
                <a href="careers/apply.php" class="btn btn-light-primary ms-3">Join Us</a>
            </div> 
            <!--end::Links-->     
        </div>  
        <!--end::Overlay-->  
    ...
    <div class="fs-5 fw-semibold text-gray-600"> 
        ...
        <p class="m-0"> 
            ...
            <a href="blog/post.php" class="link-primary pe-1">Your Post</a> 
...
<div class="mb-18">        
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Paul Miles</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Jania Garnbet</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">James Nilson</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Mia Miles</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Sophia Miles</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Oliver Lucas</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Amelia Miles</a>           
                    <!--end::Name-->
            ...
            <div class="col text-center mb-9">
                ...
                <div class="mb-0">
                    <!--begin::Name-->
                    <a href="user-profile/projects.php" class="text-dark fw-bold text-hover-primary fs-3">Liam James</a>           
                    <!--end::Name-->
...
<div class="text-center mb-20">          
    ...
    <!--begin::Action-->
    <a href="careers/apply.php" class="btn btn-primary mb-5">Apply Now</a>     
    <!--end::Action--> 
</div>
<!--end::Join-->
