...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="logs.php">
                        Logs                    </a>
                </li>
                <!--end::Nav item-->
                    </ul>
            ...
            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/invoices/in_2622_6823/payment                            </td>
                            <!--end::Status--->
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/invoice/in_5679_5954/invalid                            </td>
                            <!--end::Status--->
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/customer/c_649b18f5b63c4/not_found                            </td>
                            <!--end::Status--->
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/invoices/in_8384_1521/payment                            </td>
                            <!--end::Status--->
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/customer/c_649b18f5b63c1/not_found                            </td>
                            <!--end::Status--->
                        ...
                        <tr>
                            ...
                            <!--begin::Status--->
                            <td>
                               POST /v1/invoice/in_3856_8373/invalid                            </td>
                            <!--end::Status--->
