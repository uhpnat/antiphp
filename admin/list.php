...
<?php 
    ...
    if(isset($_GET["del"]) && ($_GET["del"])){
        $id = $_GET["del"];
        $user->del_user_id($id);
        echo '<script type="text/javascript">toastr.success("Delete success")</script>';
        header( "Refresh:1; url=list.php", true, 303);
    }
    ...
    $user->uploadImage();
    $user->add_user($user_name,$user_email, $user_password,$user_address,$user_avatar,$user_role,$user_phone);
    echo '<script type="text/javascript">toastr.success("Add success")</script>';
        header( "Refresh:1; url=list.php", true, 303);                                                              
    }
   ?>
            <!--end::Header-->
                        ...
                        <div class="d-flex flex-column flex-row-fluid">
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
                                ...
                                <div class="page-title d-flex align-items-center me-3">
                                    <img alt="Logo" src="./assets/media/svg/misc/layer.svg"
                                        class="h-60px me-5" />
                                                            ...
                                                            <form id="kt_modal_add_user_form" class="form" method="POST"
                                                                ...
                                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                                    ...
                                                                    <div class="fv-row mb-7">
                                                                        ...
                                                                        <div class="image-input image-input-outline image-input-placeholder"
                                                                            ...
                                                                            <div class="image-input-wrapper w-125px h-125px"
                                                                                style="background-image: url(./assets/media/avatars/3.jpg);">
                                                                            </div>
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                title="Change avatar">
                                                                                <i
                                                                                    class="ki-outline ki-pencil fs-7"></i>
                                                                                <!--begin::Inputs-->
                                                                    ...
                                                                    <div class="fv-row mb-7">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                            class="required fw-semibold fs-6 mb-2">Address</label>
                                                                        <!--end::Label-->
                                            ...
                                            <tbody class="text-gray-600 fw-semibold">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="view.php">
                                                                ...
                                                                <div class="symbol-label">
                                                                    <img src="./assets/media/avatars/<?php echo $item['avatar'] ?>"
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <a href="view.php"
                                                                class="text-gray-800 text-hover-primary mb-1"><?php echo $item['name'] ?></a>
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="./dashboards/finance-performance.php"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_wizards"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./utilities/wizards/horizontal.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./utilities/wizards/vertical.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_search"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./utilities/search/users.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./utilities/search/horizontal.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./utilities/search/vertical.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./authentication/email/promo-1.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./authentication/email/promo-2.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="./authentication/email/promo-3.php"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
