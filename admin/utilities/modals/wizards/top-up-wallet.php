            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="top-up-wallet.php" class="menu-link active">
        ...
        <div class="" data-kt-modal-top-up-wallet-option="dollar">
            ...
            <div class="fv-row mb-10">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-5">
                    ...
                    <div class="col">
                        <!--begin::Add new card-->
                        <a href="../forms/new-card.php" class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100">
                            <!--begin::Icon-->
