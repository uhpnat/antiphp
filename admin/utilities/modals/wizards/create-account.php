            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../general/invite-friends.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../general/view-users.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../general/select-users.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../general/upgrade-plan.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../general/share-earn.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../forms/new-target.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../forms/new-card.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../forms/new-address.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../forms/create-api-key.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../forms/bidding.php" class="menu-link ">
            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="top-up-wallet.php" class="menu-link ">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../search/users.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../search/select-location.php" class="menu-link ">
...
<!--begin::Preview-->
<a 
	href="../general/invite-friends.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="two-factor-authentication.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="../general/view-users.php">
						View Friends					</a>

											
				
					<a class="fw-6 fw-semibold" href="../general/upgrade-plan.php">
						Upgrade Plan					</a>

											
				
					<a class="fw-6 fw-semibold" href="top-up-wallet.php">
						Topup Wallet					</a>

											
				
					<a class="fw-6 fw-semibold" href="../general/share-earn.php">
						Share & Earn					</a>

											
				
					<a class="fw-6 fw-semibold" href="../general/select-users.php">
						Select User					</a>
					...
					<a class="fw-6 fw-semibold" href="../forms/bidding.php">
						Place Bid					</a>

											
				
					<a class="fw-6 fw-semibold" href="offer-a-deal.php">
						Offer Deal					</a>

											
				
					<a class="fw-6 fw-semibold" href="../forms/new-target.php">
						New Target					</a>

											
				
					<a class="fw-6 fw-semibold" href="../forms/new-card.php">
						New Card					</a>

											
				
					<a class="fw-6 fw-semibold" href="../forms/new-address.php">
						New Address					</a>
					...
					<a class="fw-6 fw-semibold" href="../general/invite-friends.php">
						Invite Friend					</a>

											
				
					<a class="fw-6 fw-semibold" href="create-project.php">
						Create Project					</a>

											
				
					<a class="fw-6 fw-semibold" href="create-campaign.php">
						Create Campaign					</a>

											
				
					<a class="fw-6 fw-semibold" href="create-account.php">
						Create Business Account					</a>

											
				
					<a class="fw-6 fw-semibold" href="create-app.php">
						Create App					</a>
					...
					<a class="fw-6 fw-semibold" href="../forms/create-api-key.php">
						Create Api Key					</a>

											
				
					<a class="fw-6 fw-semibold" href="two-factor-authentication.php">
						2 Factor Auth					</a>
...
<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 ">To start using great tools, please, <a href="../../wizards/vertical.php" class="fw-bold">Create Team Platform</a></div>
                            </div>
            <!--end::Content-->
