            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="invite-friends.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="select-users.php" class="menu-link active">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="upgrade-plan.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="share-earn.php" class="menu-link ">
            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="../wizards/top-up-wallet.php" class="menu-link ">
...
<!--begin::Preview-->
<a 
	href="../wizards/top-up-wallet.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../wizards/create-project.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../wizards/create-campaign.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../wizards/create-account.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="../wizards/two-factor-authentication.php" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="view-users.php">
						View Friends					</a>

											
				
					<a class="fw-6 fw-semibold" href="upgrade-plan.php">
						Upgrade Plan					</a>

											
				
					<a class="fw-6 fw-semibold" href="../wizards/top-up-wallet.php">
						Topup Wallet					</a>

											
				
					<a class="fw-6 fw-semibold" href="share-earn.php">
						Share & Earn					</a>

											
				
					<a class="fw-6 fw-semibold" href="select-users.php">
						Select User					</a>
					...
					<a class="fw-6 fw-semibold" href="../wizards/offer-a-deal.php">
						Offer Deal					</a>
					...
					<a class="fw-6 fw-semibold" href="invite-friends.php">
						Invite Friend					</a>

											
				
					<a class="fw-6 fw-semibold" href="../wizards/create-project.php">
						Create Project					</a>

											
				
					<a class="fw-6 fw-semibold" href="../wizards/create-campaign.php">
						Create Campaign					</a>

											
				
					<a class="fw-6 fw-semibold" href="../wizards/create-account.php">
						Create Business Account					</a>

											
				
					<a class="fw-6 fw-semibold" href="../wizards/create-app.php">
						Create App					</a>
					...
					<a class="fw-6 fw-semibold" href="../wizards/two-factor-authentication.php">
						2 Factor Auth					</a>
...
<!--end::Modal - Upgrade plan--><!--begin::Modal - Select Users-->
                            ...
                            <div class="d-flex flex-stack pb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-5"> 
                                        <!--begin::Name-->
                                        <div class="d-flex align-items-center">       
                                            <a href="../../../pages/user-profile/overview.php" class="text-dark fw-bold text-hover-primary fs-5 me-4">Emma Smith</a>
                            ...
                            <div class="d-flex flex-stack pb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-5"> 
                                        <!--begin::Name-->
                                        <div class="d-flex align-items-center">       
                                            <a href="../../../pages/user-profile/overview.php" class="text-dark fw-bold text-hover-primary fs-5 me-4">Sean Bean</a>
                            ...
                            <div class="d-flex flex-stack pb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-5"> 
                                        <!--begin::Name-->
                                        <div class="d-flex align-items-center">       
                                            <a href="../../../pages/user-profile/overview.php" class="text-dark fw-bold text-hover-primary fs-5 me-4">Lusy Kunic</a>
                            ...
                            <div class="d-flex flex-stack pb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-5"> 
                                        <!--begin::Name-->
                                        <div class="d-flex align-items-center">       
                                            <a href="../../../pages/user-profile/overview.php" class="text-dark fw-bold text-hover-primary fs-5 me-4">Mat Dillon</a>
