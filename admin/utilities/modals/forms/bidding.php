            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="new-target.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="new-card.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="new-address.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="create-api-key.php" class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="bidding.php" class="menu-link active">
...
<!--end::Row-->		
	...
	<div class="mb-10 mb-lg-17">
		...
		<div class="row">
					...
					<a class="fw-6 fw-semibold" href="new-target.php">
						New Target					</a>

											
				
					<a class="fw-6 fw-semibold" href="new-card.php">
						New Card					</a>

											
				
					<a class="fw-6 fw-semibold" href="new-address.php">
						New Address					</a>
					...
					<a class="fw-6 fw-semibold" href="create-api-key.php">
						Create Api Key					</a>
...
<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 "> Not enough funds in your wallet? <a href="../wizards/top-up-wallet.php" class="text-bolder">Top up wallet</a>.</div>
                            </div>
            <!--end::Content-->
