            ...
            <div class="col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    ...
                    <!--end:Menu heading-->
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="create-campaign.php" class="menu-link active">
                                <span class="menu-title">Create Campaign</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
...
<span class="ms-1"  data-bs-toggle="tooltip" title="Enter one or more location points for more specific targeting." >
	<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i></span>            </label>
            ...
            <!--begin::Tagify-->
            <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/metronic8/demo30/assets/media/flags/"/>
            <!--end::Tagify-->
        </div>
        <!--end::Input group-->
