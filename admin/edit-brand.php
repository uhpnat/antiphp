                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_content" class="app-content ">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $editBrand = $brand->update_brand($brandName, $id);
                            echo  $editBrand;
                        }
                        if (isset($_GET['edit'])) {
                            $id = $_GET['edit'];
                            $show = $brand->show_brand_one($id);
                        }
                        ?>
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="brand_name" class="form-control mb-2" placeholder="" value="<?php echo $show[0]['brandName']; ?>" />
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                </div>
