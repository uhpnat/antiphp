        ...
        <div class="breadcrumbs-div">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a class="font-xs color-gray-500" href="?page=shop-grid">Electronics</a></li>
                    <li><a class="font-xs color-gray-500" href="?page=shop-grid">Cell phone</a></li>
                    <li><a class="font-xs color-gray-500" href="?page=shop-grid">Accessories</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 order-first order-lg-last">
                    <div class="banner-ads-top mb-30"><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/shop/banner.png" alt="Ecom"></a></div>
                    <div class="box-filters mt-0 pb-5 border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span class="font-sm color-gray-900 font-medium border-1-right span">Showing 1&ndash;16 of 17 results</span>
                                ...
                                <div class="d-inline-block"><a class="view-type-grid mr-5 active" href="?page=shop-grid"></a><a class="view-type-list" href="shop-list.html"></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-20">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp3.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp4.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp5.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp6.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp7.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp1.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.html" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product.html"><img src="./views/assets/imgs/page/homepage1/imgsp2.png" alt="Ecom"></a></div>
                    ...
                    <div class="sidebar-border mb-0">
                        ...
                        <div class="sidebar-content">
                            <ul class="list-nav-arrow">
                                <li><a href="?page=shop-grid">Computers &amp; Laptop<span class="number">09</span></a></li>
                                <li><a href="?page=shop-grid">Electric accessories<span class="number">12</span></a></li>
                                <li><a href="?page=shop-grid">Mainboard &amp; CPU<span class="number">24</span></a></li>
                                <li><a href="?page=shop-grid">Bluetooth devices<span class="number">34</span></a></li>
                                <li><a href="?page=shop-grid">Mouse &amp; Keyboard<span class="number">65</span></a></li>
                                <li><a href="?page=shop-grid">Wired Headphone<span class="number">15</span></a></li>
                                <li><a href="?page=shop-grid">Gaming Gatgets<span class="number">76</span></a></li>
                                <li><a href="?page=shop-grid">Smart watches<span class="number">89</span></a></li>
                                <li><a href="?page=shop-grid">Cell Phones<span class="number">23</span></a></li>
                                <li><a href="?page=shop-grid">Headphone<span class="number">98</span></a></li>
                            </ul>
                            <div>
    ...
    <section class="section-box mt-90 mb-50">
        <div class="container">
            <ul class="list-col-5">
                <li>
                    <div class="item-list">
                        <div class="icon-left"><img src="./views/assets/imgs/template/delivery.svg" alt="Ecom"></div>
                ...
                <li>
                    <div class="item-list">
                        <div class="icon-left"><img src="./views/assets/imgs/template/support.svg" alt="Ecom"></div>
                        <div class="info-right">
                ...
                <li>
                    <div class="item-list">
                        <div class="icon-left"><img src="./views/assets/imgs/template/voucher.svg" alt="Ecom"></div>
                        <div class="info-right">
                ...
                <li>
                    <div class="item-list">
                        <div class="icon-left"><img src="./views/assets/imgs/template/return.svg" alt="Ecom"></div>
                        <div class="info-right">
                ...
                <li>
                    <div class="item-list">
                        <div class="icon-left"><img src="./views/assets/imgs/template/secure.svg" alt="Ecom"></div>
                        <div class="info-right">
                ...
                <div class="modal-body p-30">
                    <div class="row">
                        ...
                        <div class="col-w-1">
                            ...
                            <ul class="list-checkbox">
                                <li class="mb-5"><a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(5 stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(4 stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(3 stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(2 stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(1 star)</span></a></li>
                            </ul>
                        </div>
                        <div class="col-w-2">
                                ...
                                <div class="galleries-2">
                                    <div class="detail-gallery">
                                        <div class="product-image-slider-2">
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-1.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-2.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-3.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-4.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-5.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-6.jpg" alt="product image"></figure>
                                            <figure class="border-radius-10"><img src="./views/assets/imgs/page/product/img-gallery-7.jpg" alt="product image"></figure>
                                        </div>
                                    </div>
                                    <div class="slider-nav-thumbnails-2">
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-1.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-2.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-3.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-4.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-5.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-6.jpg" alt="product image"></div>
                                        </div>
                                        <div>
                                            <div class="item-thumb"><img src="./views/assets/imgs/page/product/img-gallery-7.jpg" alt="product image"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="product-info">
                                ...
                                <div class="info-by"><span class="bytext color-gray-500 font-xs font-medium">by</span><a class="byAUthor color-gray-900 font-xs font-medium" href="shop-vendor-list.html"> Ecom Tech</a>
                                    <div class="rating d-inline-block"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500 font-medium"> (65 reviews)</span></div>
                                </div>
                                ...
                                <div class="box-product-color mt-10">
                                    ...
                                    <ul class="list-colors">
                                        <li class="disabled"><img src="./views/assets/imgs/page/product/img-gallery-1.jpg" alt="Ecom" title="Pink"></li>
                                        <li><img src="./views/assets/imgs/page/product/img-gallery-2.jpg" alt="Ecom" title="Gold"></li>
                                        <li><img src="./views/assets/imgs/page/product/img-gallery-3.jpg" alt="Ecom" title="Pink Gold"></li>
                                        <li><img src="./views/assets/imgs/page/product/img-gallery-4.jpg" alt="Ecom" title="Silver"></li>
                                        <li class="active"><img src="./views/assets/imgs/page/product/img-gallery-5.jpg" alt="Ecom" title="Pink Gold"></li>
                                        <li class="disabled"><img src="./views/assets/imgs/page/product/img-gallery-6.jpg" alt="Ecom" title="Black"></li>
                                        <li class="disabled"><img src="./views/assets/imgs/page/product/img-gallery-7.jpg" alt="Ecom" title="Red"></li>
                                    </ul>
                                </div>
