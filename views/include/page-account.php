<main class="main">
    <section class="section-box shop-template mt-30">
        <div class="container box-account-template">
            ...
            ?>
            <p class="font-md color-gray-500">Từ bảng điều khiển tài khoản của bạn. bạn có thể dễ dàng kiểm tra và xem
                các đơn đặt hàng gần đây của mình,

                quản lý địa chỉ giao hàng và thanh toán của bạn, đồng thời chỉnh sửa mật khẩu và chi tiết tài khoản của
                bạn.</p>
                    ...
                    <div class="tab-pane fade active show" id="tab-orders" role="tabpanel" aria-labelledby="tab-orders">
                        <div id="exTab2" class="container">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#1" data-toggle="tab">Tất cả</a>
                                </li>
                                <li><a href="#2" data-toggle="tab">Đang giao</a>
                                </li>
                                <li><a href="#3" data-toggle="tab">Hoàn thành</a>
                                </li>
                                <li><a href="#4" data-toggle="tab">Đã hủy</a>
                                </li>
                            </ul>
                                                    ...
                                                    <div class="head-orders">
                                                        <div class="head-left">
                                                            ...
                                                            if ($order['status'] == 0) {
                                                                ...
                                                                echo '<span style="background-color : #5b84dd;" class="label-delivery label-delivered ">Đã xử lý</span>';
                                                            } elseif ($order['status'] == 2) {
                                                                echo '<span  class="label-delivery label-delivered ">Đang giao hàng</span>';
                                                            } elseif ($order['status'] == 3) {
                                                                echo '<span class="label-delivery label-cancel ">Đã hủy đơn hàng</span>';
                                                            } else {
                                                                echo '<span class="label-delivery   label-delivered">Giao Thành Công</span>';
                                                            }
                                                        ...
                                                        <?php
                                                        if ($order['status'] == 0) {
                                                            echo '<input type="button" class="text-danger btn cancel"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Hủy">';
                                                        } else if ($order['status'] == 1) {
                                                        } else if ($order['status'] == 2) {

                                                            echo '<input type="button" class="text-success btn status"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Đã nhận">
                                                    ';
                                                        } else if ($order['status'] == 3) {
                                                            echo '<input type="button" class="text-danger btn delete"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Xóa">';
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="item-orders">
                                                                            ...
                                                                            <div class="quantity-orders">
                                                                                <h5 style="font-size: 16px;">Số
                                                                                    Lượng:<?php echo $value['quantity'] ?></h5>
                                                                            </div>
                                                                            <div class="price-orders">
                                                                                <h3 style="font-size: 20px;">
                                                                                    <?php echo number_format($value['price'])  ?></h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                <?php } ?>
                                                ...
                                                <div class="box-orders">
                                                    <div class="head-orders">
                                                        ...
                                                        if ($order['status'] == 0) {
                                                            ...
                                                            echo '<input type="button" class="text-success btn status"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Đã nhận">
                                                            <input type="button" class="text-danger btn delete"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Xóa">';
                                                        } else if ($order['status'] == 3) {
                                                            echo '<input type="button" class="text-danger btn delete"   id="' . $id . '" style="width:100px; cursor: pointer;" value="Xóa">';
                                                        } else if ($order['status'] == 4) {
                                                        }
                ...
                <div class="modal-body p-30">
                    <div class="row">
                        ...
                        <div class="col-w-1">
                            ...
                            <ul class="list-checkbox">
                                <li class="mb-5"><a href="#"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(5
                                            stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(4
                                            stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(3
                                            stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(2
                                            stars)</span></a></li>
                                <li class="mb-5"><a href="#"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><img src="assets/imgs/template/icons/star-gray.svg" alt="Ecom"><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(1
                                            star)</span></a></li>
                            </ul>
                        </div>
                        <div class="col-w-2">
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.status', function() {
            ...
            // console.log(status_id,status_value);
            if (status_id) {
                $.ajax({
                    url: "?page=action",
                    method: "POST",
        ...
        $(document).on('click', '.delete', function() {
            ...
            if (confirm("Bạn có chắc xóa đơn hàng " + status_id)) {
                $.ajax({
                    url: "?page=action",
                    method: "POST",
                    data: {
        ...
        $(document).on('click', '.cancel', function() {
            ...
            if (confirm("Bạn có chắc hủy đơn hàng " + status_id)) {
                $.ajax({
                    url: "?page=action",
                    method: "POST",
                    data: {
