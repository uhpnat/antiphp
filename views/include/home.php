<main class="main">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-style-2 card-grid-style-2-small">
                        ...
                        <div class="info-right">
                            <a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                                <h6>Smart Phone</h6>
                            </a>
                            <ul class="list-links-disc">
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Phone Accessories</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Phone Cases</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Postpaid Phones</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Refurbished Phones</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-style-2 card-grid-style-2-small">
                        ...
                        <div class="info-right">
                            ...
                            <ul class="list-links-disc">
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">HD DVD Players</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Projection Screens</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Television Accessories</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">TV-DVD Combos</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-style-2 card-grid-style-2-small">
                        ...
                        <div class="info-right">
                            ...
                            <ul class="list-links-disc">
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Computer Components</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Computer Accessories</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Desktops</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Monitors</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-style-2 card-grid-style-2-small">
                        ...
                        <div class="info-right">
                            ...
                            <ul class="list-links-disc">
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Office Electronics</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Portable Audio &amp; Video</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Washing Machine</a>
                                </li>
                                <li>
                                    <a class="font-sm" href="shop-fullwidth.html">Accessories &amp; Supplies</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <ul class="nav nav-tabs text-start" role="tablist">
                            ...
                            <li>
                                <a href="#tab-1-mostviewed" data-bs-toggle="tab" role="tab" aria-controls="tab-1-mostviewed" aria-selected="false" data-index="3">
                                    <h4>Most viewed</h4>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 mb-30">
                    <div class="bg-5 block-iphone">
                        ...
                        <a class="btn btn-arrow" href="shop-grid.html">learn more</a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
                    <div class="bg-4 block-samsung">
                        ...
                        <a class="btn btn-brand-2 btn-arrow-right" href="shop-grid.html">learn more</a>
                    </div>
                </div>
    ...
    <section class="section-box pt-50">
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
                    <div class="bg-4 block-charge">
                        <span class="color-brand-3 font-sm-lh32">Power Bank</span>
                        <h3 class="font-xl mb-10">Quick Charge</h3>
                        <p class="font-base color-brand-3 mb-20">
                            Lightweight and Portable<br class="d-none d-lg-block" />
                            Dual port fast charge
                        </p>
                        <a class="btn btn-brand-2 btn-arrow-right" href="shop-fullwidth.html">Shop Now</a>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="bg-6 block-player">
                        ...
                        <div class="mb-30">
                            <strong class="font-16">Replacement Kit D-pad ABXY Keys</strong>
                        </div>
                        <a class="btn btn-brand-3 btn-arrow-right" href="shop-fullwidth.html">learn more</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 mb-30">
                    <div class="bg-5 block-iphone">
                        ...
                        <h3 class="font-xl mb-10">iPhone 12 Pro 128Gb</h3>
                        <p class="font-base color-brand-3 mb-10">Special Sale</p>
                        <a class="btn btn-arrow" href="shop-fullwidth.html">learn more</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                            <div class="card-grid-style-1">
                                ...
                                <div class="mt-20">
                                    <span class="color-gray-500 font-xs mr-30">September 02, 2022</span><span class="color-gray-500 font-xs">4<span> Mins read</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="card-grid-style-1">
                                ...
                                <div class="mt-20">
                                    <span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span class="color-gray-500 font-xs">5<span> Mins read</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="card-grid-style-1">
                                ...
                                <div class="mt-20">
                                    <span class="color-gray-500 font-xs mr-30">August 25, 2022</span><span class="color-gray-500 font-xs">3<span> Mins read</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="card-grid-style-1">
                                ...
                                <div class="mt-20">
                                    <span class="color-gray-500 font-xs mr-30">August 15, 2022</span><span class="color-gray-500 font-xs">7<span> Mins read</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="card-grid-style-1">
                                ...
                                <div class="mt-20">
                                    <span class="color-gray-500 font-xs mr-30">August 12, 2022</span><span class="color-gray-500 font-xs">9<span> Mins read</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
