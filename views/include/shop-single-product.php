  ...
  <section class="section-box shop-template">
    <div class="container">
        ...
        <div class="col-lg-7">
          ...
          <div class="row align-items-center">
            <div class="col-lg-4 col-md-4 col-sm-3 mb-mobile">
              <span class="bytext color-gray-500 font-xs font-medium">by</span><a class="byAUthor color-gray-900 font-xs font-medium" href="shop-vendor-single.html">
                Ecom Tech</a>
              ...
              <div class="info-product">
                <div class="row align-items-end">
                  <div class="col-lg-6 col-md-6 mb-20">
                    <span class="font-sm font-medium color-gray-900">SKU:<span class="color-gray-500">iphone12pro128</span><br />Category:<span class="color-gray-500">Smartphones</span><br />Tags:<span class="color-gray-500">Blue, Smartphone</span></span>
                  </div>
                  <div class="col-lg-6 col-md-6 mb-20">
                    <span class="font-sm font-medium color-gray-900">Free Delivery<br /><span class="color-gray-500">Available for all locations.</span><br /><span class="color-gray-500">Delivery Options & Info</span></span>
                  </div>
                  <div class="col-lg-12 mb-20">
                    <div class="d-inline-block">
                      <div class="share-link">
                        <span class="font-md-bold color-brand-3 mr-15">Share</span><a class="facebook hover-up" href="#"></a><a class="printest hover-up" href="#"></a><a class="twitter hover-up" href="#"></a><a class="instagram hover-up" href="#"></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="box-border-product">
                <div class="box-product-color">
                  ...
                  <ul class="list-colors">
                    <li class="disabled">
                      <img src="./views/assets/imgs/page/product/img-thumb.png" alt="Ecom" title="Pink" />
                    </li>
                    <li>
                      <img src="./views/assets/imgs/page/product/img-thumb.png" alt="Ecom" title="Gold" />
                    </li>
                    <li>
                      <img src="./views/assets/imgs/page/product/img-thumb.png" alt="Ecom" title="Pink Gold" />
                    </li>
                    <li>
                      <img src="./views/assets/imgs/page/product/img-thumb.png" alt="Ecom" title="Silver" />
                    </li>
                    <li class="active">
                      <img src="./views/assets/imgs/page/product/img-thumb.png" alt="Ecom" title="Pink Gold" />
                    </li>
                ...
                <div class="button-buy mt-15">
                  <a class="btn btn-cart mb-15" href="shop-cart.html">Add to cart</a><a class="btn btn-buy" href="shop-checkout.html">Buy now</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="box-bought-together">
        <div class="box-product-bought box-product-bought-2">
          <div class="product-bought">
            <img src="./views/assets/imgs/page/product/sp1.png" alt="Ecom" />
          </div>
          <div class="product-bought">
            <img src="./views/assets/imgs/page/product/sp2.png" alt="Ecom" />
          </div>
          <div class="product-bought">
            <img src="./views/assets/imgs/page/product/sp3.png" alt="Ecom" />
          </div>
          <div class="product-bought">
            <img src="./views/assets/imgs/page/product/sp4.png" alt="Ecom" />
          </div>
        </div>
      ...
      <label class="cb-container-2">
        <input type="checkbox" checked="checked" /><span class="font-md color-brand-3"><strong>This item:</strong>iPhone 12 Pro Max 128GB Pacific Blue -
          $1,099.00</span><span class="checkmark"></span>
      </label>
      <label class="cb-container-2">
        <input type="checkbox" checked="checked" /><span class="font-md color-brand-3">Apple AirPods Pro, Active Noise Cancellation, Custom Fit -
          $197.00</span><span class="checkmark"></span>
      </label>
      <label class="cb-container-2">
        <input type="checkbox" checked="checked" /><span class="font-md color-brand-3">Apple iMac 24" All-In-One Computer, Apple M1, 8GB RAM, 512GB SSD,
    ...
    <div class="container">
      <div class="pt-30 mb-10">
        <ul class="nav nav-tabs nav-tabs-product" role="tablist">
          ...
          <li>
            <a href="#tab-vendor" data-bs-toggle="tab" role="tab" aria-controls="tab-vendor" aria-selected="true">Vendor</a>
          </li>
        </ul>
        <div class="tab-content">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="comment-list">
                    ...
                    <div class="single-comment justify-content-between d-flex mb-30 ml-30 hover-up">
                      <div class="user justify-content-between d-flex">
                        <div class="thumb text-center">
                          <img src="./views/assets/imgs/page/product/author-3.png" alt="Ecom" /><a class="font-heading text-brand" href="#">Brenna</a>
                        </div>
                        <div class="desc">
                          <div class="d-flex justify-content-between mb-10">
                            <div class="d-flex align-items-center">
                    ...
                    <div class="single-comment justify-content-between d-flex hover-up">
                      <div class="user justify-content-between d-flex">
                        <div class="thumb text-center">
                          <img src="./views/assets/imgs/page/product/author-4.png" alt="Ecom" /><a class="font-heading text-brand" href="#">Gemma</a>
                        </div>
                        <div class="desc">
                          <div class="d-flex justify-content-between mb-10">
                            <div class="d-flex align-items-center">
          ...
          <div class="tab-pane fade" id="tab-vendor" role="tabpanel" aria-labelledby="tab-vendor">
            <div class="vendor-logo d-flex mb-30">
              <img src="./views/assets/imgs/page/product/futur.png" alt="" />
            ...
            <ul class="contact-infor mb-50">
              <li>
                <img src="./views/assets/imgs/page/product/icon-location.svg" alt="" /><strong>Address:</strong><span>
                  5171 W Campbell Ave undefined Kent, Utah 53127 United
                  States</span>
              </li>
              <li>
                <img src="./views/assets/imgs/page/product/icon-contact.svg" alt="" /><strong>Contact Seller:</strong><span> (+91) - 540-025-553</span>
              </li>
            </ul>
          ...
          <div class="list-products-5 mt-20">
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="image-box">
                  <span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp3.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">HP DeskJet 2755e Wireless Color All-in-One Printer</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="image-box">
                  <span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp4.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">Razer Power Up Gaming Bundle V2 - Cynosa Lite</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="image-box">
                  <span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp5.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">Apple AirPods Pro with MagSafe Charging Case</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="image-box">
                  <span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp6.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">SAMSUNG Galaxy Tab A7 Lite, 8.7&quot; Tablet 32GB</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="image-box">
                  <span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp7.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">HP 24mh FHD Monitor - Computer Monitor</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
          ...
          <div class="row mt-40">
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="card-grid-style-2 card-grid-none-border hover-up">
                <div class="image-box">
                  <a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp1.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <span class="font-xs color-gray-500">Apple</span><br /><a class="color-brand-3 font-xs-bold" href="shop-single-product-3.html">SAMSUNG Galaxy Tab A7 Lite, 8.7&quot; Tablet 32GB</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500"> (65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="card-grid-style-2 card-grid-none-border hover-up">
                <div class="image-box">
                  <a href="shop-single-product-3.html"><img src="./views/assets/imgs/page/homepage1/imgsp2.png" alt="Ecom" /></a>
                </div>
                <div class="info-right">
                  <span class="font-xs color-gray-500">Apple</span><br /><a class="color-brand-3 font-xs-bold" href="shop-single-product-3.html">Class 4K UHD (2160P) LED Roku Smart TV HDR</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500"> (65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="card-grid-style-2 card-grid-none-border hover-up">
                ...
                <div class="info-right">
                  <span class="font-xs color-gray-500">Apple</span><br /><a class="color-brand-3 font-xs-bold" href="shop-single-product-3.html">HP 24mh FHD Monitor - Computer Monitor with
                    23.8-Inch</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500"> (65)</span>
                  </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="card-grid-style-2 card-grid-none-border hover-up">
                ...
                <div class="info-right">
                  <span class="font-xs color-gray-500">Apple</span><br /><a class="color-brand-3 font-xs-bold" href="shop-single-product-3.html">Logitech H390 Wired Headset, Stereo Headphones</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500"> (65)</span>
                  </div>
                  <div class="price-info">
          ...
          <div class="list-products-5 mt-20">
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">Logitech MK345 Wireless Combo Full-Sized Keyboard</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">Logitech Brio 4K Webcam, Ultra 4K HD Video Calling</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">2022 Apple iMac with Retina 5K Display 8GB RAM</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
            ...
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
                ...
                <div class="info-right">
                  <a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br /><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.html">Seagate Portable 2TB External Hard Drive</a>
                  <div class="rating">
                    <img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="font-xs color-gray-500">(65)</span>
                  </div>
                  <div class="price-info">
        ...
        <div class="modal-body p-30">
          <div class="row">
            ...
            <div class="col-w-1">
              ...
              <ul class="list-checkbox">
                <li class="mb-5">
                  <a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(5 stars)</span></a>
                </li>
                <li class="mb-5">
                  <a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(4 stars)</span></a>
                </li>
                <li class="mb-5">
                  <a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(3 stars)</span></a>
                </li>
                <li class="mb-5">
                  <a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(2 stars)</span></a>
                </li>
                <li class="mb-5">
                  <a href="#"><img src="./views/assets/imgs/template/icons/star.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><img src="./views/assets/imgs/template/icons/star-gray.svg" alt="Ecom" /><span class="ml-10 font-xs color-gray-500 d-inline-block align-top">(1 star)</span></a>
                </li>
              </ul>
            </div>
            <div class="col-w-2">
                ...
                <div class="buy-product mt-5">
                  ...
                  <div class="box-quantity">
                    ...
                    <div class="button-buy">
                      <a class="btn btn-cart" href="shop-cart.html">Add to cart</a><a class="btn btn-buy" href="shop-checkout.html">Buy now</a>
                    </div>
                  </div>
                </div>
              </div>
